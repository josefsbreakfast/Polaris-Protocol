...
```mermaid
flowchart LR
  A[Actor / Campaign] --> B[Channel Control – media · influencers · ads]
  B --> C[Framing Signal – euphemism · metaphor · label]
  C --> D[Algorithmic Repeat – boosts · trends · recommendation]
  D --> E[Social Adoption – in-group normalisation]
  E --> F[Semantic Erosion – meaning becomes ambient]
  F --> G[Institutionalisation – policy · law · bureaucracy]
```
