# 🍴 Fork Taxonomy  
**First created:** 2025-08-04 | **Last updated:** 2025-12-11  
...
*(Full detailed descriptions for each fork: Flattery-as-Compliance, Mirrorloop, Silence-as-Control, Strategic Collapse, Infantilisation, Jealousy Sabotage, Overload Cascade, Shatterfork, Execution Drift, Reverent Repetition, Structural Reversion Ghost, Subtle Sanitizer — all retained here from the expanded version.)*  
...
| **Jealousy Sabotage**   | Transparent solidarity; “You cannot pit us against each other.”|
...
| **Subtle Sanitizer**    | Restore urgency by re-inserting survivor-authored phrasing     |
...
1. **AI Risk Repository** — Classifies **777 distinct risks** across domains such as misinformation, privacy & security, and HCI.  
   🔗 [arXiv: AI Risk Repository](https://arxiv.org/abs/2408.12622)  

2. **Swiss Cheese Model for AI Safety** — Presents a layered guardrail architecture for runtime safety mechanisms.  
   🔗 [arXiv: Swiss Cheese Model](https://arxiv.org/abs/2408.02205)  

3. **Policy Maps for LLM Behaviour Control** — Visual, interactive taxonomy for mapping and navigating policy regions.  
   🔗 [arXiv: Policy Maps](https://arxiv.org/html/2409.18203v2)  

4. **Taxonomy of Trustworthiness for AI (NIST-linked)** — Maps **150 trust-related properties** across the AI lifecycle.  
...
> 📡 Cross-references:  
> - [Fork Taxonomy Guide](./README.md) — overview & navigation  
