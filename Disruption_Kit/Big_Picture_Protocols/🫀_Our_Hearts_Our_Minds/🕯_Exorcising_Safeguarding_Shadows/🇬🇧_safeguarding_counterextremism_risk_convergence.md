...
**First created:** 2025-09-01 | **Last updated:** 2026-02-19  
...
From a forensic governance and psychology perspective, perpetrators — particularly institutional or high-power actors — assess behaviour according to **risk–reward heuristics**. Where governance structures increase reward without proportionate accountability, **the likelihood of predation rises**.
...
Safeguarding–counterextremism convergence is rarely the result of a single explicit policy choice.  
...
- unified risk-scoring or “early intervention” tools applied to heterogeneous harms,  
- cross-agency information-sharing agreements justified as efficiency or prevention,  
- and reclassification of vulnerability indicators as “pre-extremism signals.”
...
| Safeguarding + Counterextremism | Survivor data + security intelligence| **Critical — dual payoff attracts entrenched perpetrators** |
...
This combination is rare — and therefore attractive.

---

## ⚖️ Perpetrator Incentive Analysis  

Perpetrators operating within institutions respond to **structural incentives**, not moral narratives.

- **Low risk + high reward** → opportunistic misuse  
  (e.g. frontline or mid-level access abuse, informal information trading)

- **High risk + very high reward** → institutional exploitation  
...
The effect is not protection — it is **role reversal**.

---

## ⚖️ Legal Failure Mode: Category Collapse  
...
## 🧠 Ethical Breach: When Care Becomes Suspicion  
...
**convergence → misuse → secrecy → lack of redress → continued convergence**
