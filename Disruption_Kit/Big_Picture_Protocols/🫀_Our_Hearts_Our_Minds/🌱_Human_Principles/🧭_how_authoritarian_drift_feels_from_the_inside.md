...
```mermaid
flowchart TB
    A["Atmospheric Disturbance"] --> B["Behavioural Contraction"]
    B --> C["Bureaucratic Distortion"]
    C --> D["Pattern Recognition"]
    D --> E["Minority Alerts<br>('we’ve seen this before')"]
    E --> F["Public Realisation<br>(years later)"]
```
