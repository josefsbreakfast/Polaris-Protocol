...
```mermaid
flowchart TB
    A["Confusion / Dissonance"] --> B["Accumulated Evidence"]
    B --> C["Contradiction Becomes Impossible to Ignore"]
    C --> D["Cognitive Click"]
    D --> E["Emotional Release / Validation"]
    E --> F["Stabilisation<br>(self-trust returns)"]
```
