...
```mermaid
flowchart LR
    A[Known but unnamed risk] --> B[Strategic ambiguity]
    B --> C[Institutional comfort]
    C --> D[Pressure: leaks • advocacy • fatigue]
    D --> E[Forced naming]
    E --> F[Policy realignment]
    F --> G[Public relief + bureaucratic panic]
    G --> C
```
