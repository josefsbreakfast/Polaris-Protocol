...
```mermaid
graph TD
    L1[💔 1. Recognition<br/>Admit systemic capture; name the harm] --> 
    L2[📜 2. Documentation<br/>Preserve evidence, stories, and data before erasure] -->
    L3[🤝 3. Connection<br/>Re-knit local trust webs; form care clusters] -->
    L4[🍞 4. Provision<br/>Mutual-aid for food, shelter, health, bandwidth] -->
    L5[🧱 5. Assembly<br/>Neighbourhood councils, citizen juries, participatory forums] -->
