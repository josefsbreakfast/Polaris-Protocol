...
## 🛰️ Orientation
Germany once responded to reassurance due to trauma-coded pacifism.  
After 2022, that script collapsed.

## ✨ Key Features
- Single-use soothing window  
- Trauma-coded diplomacy  
- Lavrov’s brief resonance  
- Narrative rupture

## 🧿 Analysis / Content
Germany’s trauma prevented militarism.  
Lavrov fit that script *once*.  
After invasion → soothing becomes impossible.
