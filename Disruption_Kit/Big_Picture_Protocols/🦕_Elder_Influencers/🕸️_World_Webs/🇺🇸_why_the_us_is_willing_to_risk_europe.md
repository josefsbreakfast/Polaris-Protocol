...
The primary long-term strategic focus is shifting toward China.
...
> The US is more willing to accept marginal risk in Europe to focus on Asia.

---

## 💰 Burden-Sharing Logic  
...
> Apply pressure to encourage European capability-building
...
US foreign policy is shaped by internal dynamics:
...
## ⚖️ Trade-Off Structure  

The US is balancing:

| Goal | Risk |
|--|--|
| Focus on China | Reduced European deterrence |
| Encourage European spending | Alliance instability |
| Reduce overseas footprint | Slower response capability |
| Maintain influence | Perception of unreliability |
...
- US influence becomes less automatic  
- NATO becomes less integrated  

If calibrated successfully:

- Europe strengthens  
- burden is shared  
- alliance adapts without fragmentation  
