...
```mermaid
flowchart TD
  A[⚠️ Institutional Stress / Failure] --> B[🩹 Emergency Patchwork]
  B --> C[🚒 Failure Containment]
  C --> D[🗂️ Maintenance & Stabilisation]
  D --> E[🫀 Trust Reconstruction]
  E --> F[🌱 Adaptive Redesign]

  F --> G[🧱 Distributed Resilience]
  G --> H[🧪 Iterative Governance Learning]

  H --> D

  I[📉 Neglected Maintenance] -.-> A
  J[⚡ Optimisation Pressure] -.-> A
```
