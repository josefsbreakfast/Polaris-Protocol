...
This node examines the “gift horse” problem in AI-enabled digital government.
...
A gift horse is not automatically unlawful.

But a public-sector gift horse becomes legally significant when:

- the public is not clearly told what is inside it;
- different technical objects are described using the same friendly language;
- commercial and state-owned systems are bundled together rhetorically;
- identity, access, data-sharing, and AI decision-support begin to converge;
...
- a service-access mechanism;
- a data-linkage architecture;
- or an AI-ready public-service operating layer.

Those are not the same thing.

Likewise, “AI in public services” may mean:

- internal productivity tools;
- commercial enterprise AI;
- sovereign or in-house government AI;
...
The legality of the gift horse depends partly on whether the public, Parliament, regulators, courts, and affected individuals can see:

- who built the horse;
- who owns the horse;
- who maintains the horse;
