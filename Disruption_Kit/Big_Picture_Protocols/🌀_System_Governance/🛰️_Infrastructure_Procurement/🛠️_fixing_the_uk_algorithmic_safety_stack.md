...
## 🧭 Orientation  
The UK did not build a single censorship engine; it built a tangle of overlapping “safety” mechanisms — legal, commercial, and technical — that now collide.  
...
| **Platform moderation** | Protect users from “harmful but legal” material | Shadow bans, algorithmic opacity | Corporate self-regulation under Ofcom |
...
3. **Proportional-Risk Design**  
   Shift from “zero harm” to “justified intervention.”  
   Publish cost–benefit assessments showing how each safety mechanism balances protection against expression.
...
## 🌌 Constellations  
🛠️ 🧱 ⚙️ 🧩 — lives alongside *The Rise of Algorithmic Safety in the UK Internet* and *Containment as Emergent System Behaviour.*
