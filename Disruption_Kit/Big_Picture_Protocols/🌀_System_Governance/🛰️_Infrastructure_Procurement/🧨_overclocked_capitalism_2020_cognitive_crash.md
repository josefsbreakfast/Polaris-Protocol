...
- Pandemic-induced cognitive depletion: grief → burnout → impaired oversight.  
...
Fewer staff → more targets → constant crisis posture.  
...
A[Overclocked Capitalism<br/>2010–2020] --> B[Populations Running Hot<br/>No Slack Capacity]
B --> C[2020 Shock<br/>Mass Disablement & Bereavement]
C --> D[Cognitive Depletion<br/>Burnout • Impaired Oversight]
D --> E[LLMs Adopted as Prosthetic Cognition]
E --> F[Humans Step Out of the Loop<br/>Minimal Verification]
F --> G[Systemic Safety Gap<br/>Unchecked Inputs & Outputs]
G --> H[Imperial-Core Amplifier<br/>High Adoption + High Exhaustion]
H --> I[Epistemic Attack Surface<br/>Low-Cost Sabotage Vector]
I --> J[Cascading National Risk<br/>Drift • Disinfo • Governance Erosion]
```
...
A[Overclocked Capitalism] --> B[Population Burnout<br/>Cognitive Depletion]
B --> C[LLMs Used as<br/>Prosthetic Cognition]
C --> D[Human Oversight Collapses<br/>Copy–Paste Culture]
D --> E[Epistemic & Security Failures<br/>Subtle Errors, Drift, Poisoning]
E --> F[Institutional Stress & Crisis Mode<br/>More Firefighting, Less Reflection]
F --> B
```
...
subgraph ADVERSARIES[Adversarial Actors]
  A1[Hostile States]
  A2[Extremist / Terror Networks]
  A3[Mercenary Info-Ops Shops]
  A4[Opportunistic Hackers]
end

subgraph ENV[Imperial-Core Environment]
  E1[Burned-Out Workforce]
  E2[High LLM Adoption<br/>in Everyday Workflows]
  E3[Hollowed Oversight<br/>Thin Security Teams]
end

subgraph LLMSTACK[LLM Stack / Pipeline]
  L1[Prompts & Inputs]
  L2[Models & Fine-Tunes]
  L3[Outputs in Docs,<br/>Code, Policy, Comms]
end

subgraph IMPACT[Impact Surface]
  I1[Org Decisions Drift]
  I2[Public Discourse Distorted]
  I3[Security Controls<br/>Quietly Undermined]
  I4[Training Data<br/>Progressively Contaminated]
end
...
%% Imperial core conditions that make it work
E1 --> L1
E2 --> L3
E3 --> IMPACT
...
%% Feedback of damage back into environment
I1 --> E3
I2 --> E1
I4 --> L2
```
...
*🧨 Overclocked Capitalism & the Post-2020 Cognitive Crash* is a living node of the **Polaris Protocol**.  
...
> 📡 Cross-references:  
>   
> • **🌀 Systems & Governance** — structural failure modes in late-stage economies  
> • **✨ Glimmer_Is_Taxable_And_Other_Big_Drums** — symbolic economies and crisis logic  
> • **🧠 Psychological_Containment** — cognitive load as a suppression vector  
