...
**First created:** 2025-11-09 | **Last updated:** 2025-12-25  
...
```mermaid
graph TD
  A[Authoritarian Drift]
  B[Fragmented Opposition]
  C[Cross-Ideological Coalition]
  D[Civic Oversight]
  E[Institutional Renewal]

  A --> B
  B --> C
  C --> D
  D --> E
  E -->|"Restores accountability feedback"| A
```
