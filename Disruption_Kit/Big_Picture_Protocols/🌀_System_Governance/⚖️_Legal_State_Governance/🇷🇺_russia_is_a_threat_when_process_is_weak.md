...
- The same procedural fragilities exposed in Gaza-related decision-making are the conditions Russia historically exploits.
...
- and precedent anxiety overriding principle.

Each creates exploitable seams:
- delegitimised norms,
- fractured alliances,
- cynicism among publics,
...
- and “values-based foreign policy” can fracture under alliance pressure.
...
- and weaponising procedural hypocrisy.

When the West:
- insists on rules for adversaries,
- but treats allies as exempt,

the informational terrain tilts.

This is not propaganda success.  
...
- accepts short-term alliance friction,
- and preserves institutional credibility.

A process-weak state:
- manages risk instead of reducing it,
- outsources moral injury downward,
- and treats law as ambience.

Only the latter is strategically fragile.
...
Security is not enforced by posture alone.  
It is enforced by **process integrity**.
