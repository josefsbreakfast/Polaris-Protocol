...
This node sets out a simple proposition:

> **A state that tolerates elite impunity — particularly for sexual exploitation, abuse, or coercive misconduct — creates a standing national security vulnerability.**

This is not a moral claim.
It is a counter-intelligence and state-capacity claim.
...
The risk is not that “everyone knows”.
The risk is that **someone else finds out first**.
...
## 🛰️ Why Foreign and Criminal Actors Care
...
## 🧠 Institutional Silence Increases Coercibility
...
## 🏛️ Democratic Legitimacy as a Security Asset

States do not only defend borders.
...
## 🌍 International Standing and Soft Power Loss
...
They do **not** close the vulnerability window.

From a security standpoint, they are **damage control**, not risk elimination.

---

## 🔥 Prosecution as Risk Reduction
...
A state that cannot prosecute its most powerful offenders is not merely unjust.

It is **strategically exposed**.

Elite accountability is not optional ethics.
