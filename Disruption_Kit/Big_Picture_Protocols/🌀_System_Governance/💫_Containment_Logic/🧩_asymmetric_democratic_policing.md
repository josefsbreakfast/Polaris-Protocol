...
```mermaid
flowchart LR
    A["High Visibility Groups"] --> B["Low Political Cost to Scrutinise"]
    B --> C["Disproportionate Intervention"]
    C --> D["Data Accumulation & Flags"]
    D --> E["Increased Apparent Risk<br>(self-confirming loop)"]

    F["Powerful Actors"] --> G["High Political Cost to Scrutinise"]
    G --> H["Avoidance / Soft Intervention"]
    H --> I["Low Data Generation"]
    I --> J["Decreased Apparent Risk<br>(self-confirming loop)"]
```
