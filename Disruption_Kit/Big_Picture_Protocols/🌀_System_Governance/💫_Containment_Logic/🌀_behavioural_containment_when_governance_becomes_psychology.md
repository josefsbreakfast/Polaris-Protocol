...
```mermaid
flowchart TD
A["Challenge to authority 💬"] --> B["Psychological framing 🧠"]
B --> C["Behavioural tagging 🏷️"]
C --> D["Safeguarding referral or HR process ⚙️"]
D --> E["Reputational isolation 🪞"]
E --> F["Institutional forgetting 🌫️"]
F --> A["Cycle restarts when next whistleblower appears 🔁"]
```
