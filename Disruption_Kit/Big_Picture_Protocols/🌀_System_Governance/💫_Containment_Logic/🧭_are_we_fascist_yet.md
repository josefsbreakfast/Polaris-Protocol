...
```mermaid
flowchart LR
A[Democracy ↔ Rule of Law] --> B[Regulatory Capture]
B --> C[Protofascism ↔ Authoritarian Function]
C --> D[Fascism Attempt ↔ Totalisation]
C --> E[Reconstruction ↔ Commons-Led Renewal]
```
