...
- or that readers are stupid for drawing conclusions.

It explains how **perfectly reasonable assumptions** can still produce a misleading story — especially under pressure.  
...
When an outlet’s phrasing subtly frames an act as a “response to” a particular campaign, readers naturally fill in the gaps with what they already know.
...
Many:
- serve a *broad* progressive or left-leaning audience,
- operate from a professional distance,
- and are not involved in day-to-day organising or long-term campaign strategy.

As a result, their mental model of a movement may be:
- shaped by headlines,
- shaped by past coverage,
- shaped by what “looks like” similar protests,
- rather than by deep familiarity with campaign logic.

That doesn’t make them malicious.
It makes them **adjacent** rather than embedded.
...
That conclusion feels *reasonable* — even if it’s wrong.

This is precisely why precision matters.
...
- Politicians, when targeted, are usually engaged through:
  ...
  - or symbolic protest — not property damage.
...
- and continued post-austerity stagnation,

anger does not always express itself neatly.

Sometimes people:
- borrow the language of visible movements,
- attach themselves rhetorically to high-profile causes,
- or frame their actions under a banner that feels morally legible.

This is not unique to the left.
It is a well-documented feature of political radicalisation across ideologies.
...
- and the people whose lives are at risk (e.g. hunger strikers) are further sidelined.
...
- distinguish appearance from pattern,
- and resist narrative shortcuts — even when they feel intuitive.
