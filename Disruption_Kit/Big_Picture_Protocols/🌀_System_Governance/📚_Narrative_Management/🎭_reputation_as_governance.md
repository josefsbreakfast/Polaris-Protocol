...
```mermaid
flowchart TD
A["Harm or anomaly 💥"] --> B["Narrative control cell 🗞️"]
B --> C["Managed communication 🗣️"]
C --> D["Reputation stabilisation 🛡️"]
D --> E["Institutional resilience report 📊"]
E --> F["Public belief in governance restored 🔁"]
```
