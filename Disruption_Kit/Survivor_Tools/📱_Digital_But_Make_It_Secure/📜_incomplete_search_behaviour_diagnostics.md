...
This node maps the diagnostic signs that a search was *not* complete —  
even if they assert it was.

---

# 🧩 The Nine Diagnostically Reliable Signs of an Incomplete Search  
...
- “We searched the X team’s files…”  
- “We checked our main system…”  
- “We reviewed the email account of…”  
...
…it means they did not query the underlying systems.
...
- FOI: “We do not use automated profiling.”  
...
If these are absent,  
you know they didn’t search organisational communications.

---

## **5. “We Found Nothing” Replies for High-Activity Periods**  
...
- the SAR’s timestamps do not match their stated processing practices,  
- processing happened outside office hours,  
- logs appear in batch cycles,  
- there are timezone mismatches,

…it means another system was involved that they did not search.

---

## **8. Abruptly Short Responses**  
Any response under ~2–4 pages for a complex case is suspicious.
...
## **9. “We Searched What You Asked For” (But They Didn’t Ask Clarifying Questions)**  
...
# 🧨 How Incomplete Search Produces Systemic Contradictions  

Incomplete searches surface as:

### ✔ Event–Record Inconsistency  
e.g.,  
You have lived experience of an event →  
They have zero internal records of it.

### ✔ FOI–SAR Mismatch  
One response names a system the other doesn’t.
...
# 🔧 How to Present Incomplete Search Without Accusation  

Use gentle phrasing such as:

- “This may indicate the search was not sufficiently wide.”  
- “There appear to be discrepancies between your systems’ metadata and the search results.”  
- “Could you confirm whether cloud environments or vendor-held data were included in the search?”  
- “There may be additional systems that were not captured.”
...
# 🧠 Key Insight  
> **Incomplete search behaviour is not malicious —  
> it is structural.  
>  
> But it reveals where the truth is hiding.**

In Polaris, “incomplete search” is the first layer of forensic illumination.
