...
Example:  
- [`🍉_hunger_strikes_in_2025.md`](./🍉_hunger_strikes_in_2025.md)

### 🍞 **Food scarcity as social control**  
...
%% Title
A0["THE HUNGER GAMES: 2025<br/>(Bureaucracy Edition™)"]

%% Capitol
A1["🏛️ Capitol HQ<br/>(Cabinet + Comms Grid)"]

A0 --> A1

%% Tier 1 Districts
A2["🍞 District 1:<br/>Food Inflation<br/>(Supermarkets + Monopolies)"]
A3["⚙️ District 2:<br/>Algorithmic Scoring<br/>(Risk Models + “Lifestyle Flags”)"]
A4["📑 District 3:<br/>Welfare Sanctions<br/>(Biometrics + Conditionality)"]
...
%% Tier 1 notes
A2a["“Prices go up, wages stand still.”"]
A3a["“Your data twin committed a thought-crime in Tesco.”"]
A4a["“Starvation, but made procedural.”"]
...
%% Tier 2 Districts
A5["🍽️ District 4:<br/>Prison Diets<br/>(Nutritional risk assessments)"]
A6["🛄 District 5:<br/>Migrant Hostels<br/>(Asylum rationing + queue algorithms)"]
A7["🔥 District 6:<br/>Climate Shock<br/>(Crop failure + insurance collapse)"]

A1 --> A5
A1 --> A6
A1 --> A7

A5a["“You lost 3kg; must be malingering.”"]
A6a["“We’ll feed you once we decide you exist.”"]
A7a["“Famine but in PowerPoint.”"]
...
%% Tier 3 Districts
A8["🚢 District 7:<br/>Supply Chain Collapse<br/>(Strikes + ports + wars)"]
A9["📉 District 8:<br/>Data Poverty<br/>(Signal starvation)"]
A10["🧾 District 9:<br/>Digital Purchase Histories<br/>(“Why did you stop buying bagels?”)"]

A1 --> A8
A1 --> A9
A1 --> A10

A8a["“There is no bread, but there is a QR code.”"]
A9a["“If you buy nothing, we can’t model you.”"]
A10a["“Your hunger is now a consumer anomaly.”"]
...
%% Final Arena
A11["🏟️ FINAL ARENA:<br/>Sacrificial Protest<br/>(Hunger Strikes 2.0)"]
A1 --> A11
A11a["“May the odds be ever in your risk category.”"]
A11 --> A11a
```
