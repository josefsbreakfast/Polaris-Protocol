...
```mermaid
flowchart TB
    A["Budget Cycle Approaches"] --> B["Strategic Ambiguity Introduced"]
    B --> C["Imaginary Underwater Risk Constructed"]
    C --> D["Prestige & Funding Justified"]
    D --> E["Opaque Procurement Locked In"]
    E --> F["Threat Never Verified (success!)"]
```
