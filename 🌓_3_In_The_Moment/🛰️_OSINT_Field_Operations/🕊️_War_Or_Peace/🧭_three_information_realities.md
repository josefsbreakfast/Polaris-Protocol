...
```mermaid
graph TD
A[Students / Activists<br>Livestream & OSINT feeds] -->|Moral urgency| B[University Risk Systems<br>Procedural filters]
B -->|Escalation data| C[Government / Regulators<br>Security dashboards]
C -->|Directives, funding logic| B
B -->|Disciplinary action / comms| A
A -->|Outrage amplification| C
```
