...
```mermaid
flowchart LR
  A[Behavioural stimulus] --> B{Legitimacy present?}
  B -->|Yes| C[Empathy + guilt loops engage]
  C --> D[Reduced violence, cooperation]
  B -->|No| E[Reactance + moral injury]
  E --> F[Heightened resistance]
  F --> G[Collapse of legitimacy]
```
