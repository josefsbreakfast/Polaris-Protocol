...
There was one set of instructions.
...
One institutional decision capable of shaping years of education, employment and family life.

But the machinery producing that result was not one institution acting alone.
...
The examination was produced through a chain.

That difference matters.

When the system worked, centralisation allowed the authority to claim consistency, efficiency, national comparability and public legitimacy.
...
delivery fragmented outward
        ↓
failure identified somewhere below
        ↓
...
The problem is not that national coordination exists.
...
A regional failure may harm one cohort.

A failure inside a national gateway can disturb the allocation of an entire future.

The scale of centralisation therefore creates a corresponding duty of care.
...
A contractor may understand the testing software.

A logistics company may control physical movement.

A centre operator may know the premises.

A biometric supplier may control the authentication workflow.

A subcontractor may recruit temporary staff.

A vendor may retain access to technical logs.

An external specialist may understand the system well enough to diagnose failure when the public authority cannot.
...
It may remain extremely powerful when dealing with candidates.
...
It does establish that the examination authority’s operational environment extends well beyond its permanent internal staff.
...
Public bodies routinely purchase specialist services.

A contractor may possess expertise the public authority could not efficiently reproduce internally.
...
review and translation
        ↓
printing or digital deployment
        ↓
secure transport or transmission
        ↓
storage
        ↓
centre preparation
...
Who possessed the material?

Who could alter it?

Who recorded the transfer?

Who supervised the actor?

Who received the incident report?

Who could compare the expected process with what actually occurred?

A system may contain individually competent suppliers and still fail at the interfaces between them.

One supplier may assume another is responsible.

One database may not speak properly to another.

Local staff may receive incomplete instructions.

Technical support may not understand examination policy.

The central authority may receive summary reporting without enough underlying information to identify the problem.

This is why the integrity of a high-stakes examination cannot be reduced to the quality of any single vendor.
...
That can make contracting manageable.

It can also conceal the institutional task that remains after the contracts are awarded.
...
The examination existed in the interaction between those responsibilities.

The candidate did not sit one contract at a time.

The candidate sat one examination.
...
If a secure and accessible system works nationally, millions of candidates may benefit.

If the system contains a weakness, the same architecture can reproduce that weakness at scale.

Centralisation therefore changes the meaning of risk.
...
Students know where authority appears to sit.

The government may prefer to describe the problem as distributed across centres, criminals, vendors and states.
...
The same explanation should increase, not reduce, the standard expected from the institutions delivering it.
...
It tells the student something about how the institution understands responsibility.

A candidate’s small procedural failure may be treated as disqualifying.

An institutional failure affecting thousands may be treated as complex.
...
It does not prove that the authority could govern the service properly.

Institutional capability requires more than buying access to a product or workforce.
...
Who asked the public to trust it?

Who possessed the authority to change it after failure became visible?

These categories may identify different actors.
...
It cannot fully delegate the public duty attached to those tasks.
...
The candidate could not negotiate the terms.

The candidate could not audit the supplier.

The candidate was compelled to trust the system selected for them.
...
It is evidence that the problem was recognised as larger than one student complaint or one isolated centre.
...
A system can respond to failure by purchasing a more elaborate version of itself.

That may improve security.

It may also deepen the hollow centre.

The relevant test is not whether the redesigned system looks more sophisticated.
...
Those gaps are not administrative trivia.
...
contractual allocation of responsibility
        ↓
documented operational practice
        ↓
documented failure
        ↓
established breach
...
Institutional caution should refine accountability.
...
That chain did not reduce the authority’s responsibility.

It increased the authority’s duty to understand what was being done in its name.

The system was strictest with the people who had the least power over its design.

When the machinery failed, complexity became an explanation.
