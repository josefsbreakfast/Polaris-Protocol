...
-   survivor testimony accumulating before the disclosure cascade;
-   institutional failure becoming visible across sectors;
-   the older anti-political-correctness repertoire and its internet
    descendants;
-   Gamergate as a case study in asymmetric exposure and competing
    remembered histories;
-   doxxing, threats, swatting, pile-ons, and other harms becoming
    legible to some communities before mainstream recognition;
-   target-conditioned threat literacy;
-   partitioned participation inside networked political conflict;
-   the difference between content, exposure, belief, participation, and
    action;
-   Cosby and Savile as different forms of pattern recognition;
-   social media as a lateral evidence network;
-   2016--2017 as a threshold period rather than a single-cause
    explanation;
-   MeToo as a disclosure cascade built on pre-existing knowledge,
    networks, and unresolved institutional failure.
...
-   one complaint to previous complaints;
-   one institution to comparable failures elsewhere;
-   one industry's "open secret" to another industry's;
...
It increasingly made comparison possible.

---

### 2. The Older Argument Underneath the New Internet One
...
-   How should free expression interact with anti-discrimination
    obligations?
-   Which equality interventions work?
-   Which are symbolic, ineffective, or counterproductive?
-   How should universities handle genuinely contested ideas?
...
> equality claim
> → language or institutional change
...
### 3. Transgression as Authenticity
...
> "I dislike being told what I am allowed to say."

That is a much larger recruitment pool.

---

### 4. 2014--2016: The Harassment Wars Were Also Information Wars
...
-   threats;
-   account compromise;
-   attempts to interfere with employment or public appearances;
-   malicious reporting;
-   stalking;
...
> a debate about games journalism.

Another:

> an argument about feminist criticism.

Another:

> anti-SJW humour and memes.

Another:

> a community organised around resentment of feminism.

Another:

> doxxing and credible concern for their physical safety.

Another:

> explicit ideological threats of violence.
...
They were not necessarily in the same **informational place**.

---

### 5. Gamergate: Same Event, Different Threat Environment
...
### 6. Target-Conditioned Threat Literacy

The internet did not merely make more information available.
...
> members of targeted groups acquire specialised historical,
> ideological, and practical knowledge because interpreting contemporary
...
### 7. The Double Edge: Threat Literacy and Grievance Literacy
...
Propaganda tends to collapse:

> this resembles X
> → therefore this is X
> → therefore our enemy caused it
> → therefore our worldview is confirmed.

---

### 8. Novel Public Recognition Is Not Novel Emergence
...
> **new behaviour**
> ≠ **newly named behaviour**
> ≠ **newly visible to institutions**
> ≠ **newly politically salient behaviour**
...
### 10. When Reports of Harm Become Evidence for the Worldview
...
> behaviour
> → another person reports harm
> → report supplies new information
> → behaviour or model can update

Ideologically armoured loop:

> behaviour
> → another person reports harm
> → report interpreted as censorship / manipulation / enemy action
> → worldview confirmed
> → correction becomes less likely

A movement does not need to teach:
...
### 11. The Cosby Effect: Aggregation Changes Credibility
...
> one account may be isolated;
> many accounts make the isolation itself harder to sustain.

This was an important precursor to MeToo's later scale.

The disclosure threshold was becoming social as well as individual.

---

### 12. Savile: Institutional Failure Becomes Part of the Story
...
-   and what organisations did or failed to do with information
    available to them.

The important cultural change was not simply:

> "a famous man was abusive."
...
Both involve fragmented knowledge.
...
### 13. Social Media as a Lateral Evidence Network
...
-   Facebook groups;
-   forums;
-   feminist blogs and media;
-   backchannel warnings;
-   survivor networks;
-   public threads;
-   and informal archives of screenshots, links, names, and incidents.
...
That is a major part of the long fuse.

---

### 14. Institutional Saturation: Different Sectors, Recurring Problems
...
It could alter the environment around accountability.
...
-   high-value individuals receiving exceptional tolerance;
-   insecure workers carrying greater disclosure risk;
-   NDAs and legal pressure;
-   and whisper networks emerging where formal systems were not trusted.
...
### 15. Male Survivors Belong in the Pattern --- Without Making This Node Do Two Jobs
...
Silence](./🪨_male_survivor_silence.md), where differences between boys,
adult men, trans men, institutional settings, disclosure barriers, and
evidential limits can be treated properly.

---

### 16. 2016: Political Shock Meets Existing Information Architecture

The 2016 US election did not create the preceding dynamics.
...
> "What happens when an individual institution protects a powerful man?"
...
### 17. 2016--2017: The Respectable Translation Layer
...
-   concern about compelled speech;
...
### 18. Content Is Not Exposure Is Not Belief Is Not Action

The long fuse should not be reconstructed as:

> misogynistic content existed
> → men saw it
> → men believed it
> → men became violent.

That collapses several distinct stages.

Keep them separate:

> **content ≠ exposure ≠ belief ≠ participation ≠ action**
...
That is a cybernetic question, not a morality play.

---

### 19. 2017: From "I Know" to "We Can Compare"

By 2017, several barriers to collective recognition had weakened.
...
None of this guaranteed MeToo.

It changed the conditions under which disclosure occurred.

The important threshold was not simply:
...
When reading this period, preserve the following separations:

---
  Do not collapse                     Why it matters
  ----------------------------------- -----------------------------------
  roots ↔ platforms                   misogyny and inequality predate
                                      recommender systems

  content ↔ exposure                  material can exist without reaching
                                      a particular user

  exposure ↔ belief                   seeing a claim does not establish
                                      persuasion

  belief ↔ action                     ideology does not mechanically
                                      determine conduct

  participant ↔ organiser             network membership does not imply
                                      equal knowledge

  mainstream layer ↔ violent edge     they may share narratives without
                                      sharing methods

  pattern recognition ↔ narrative     historical comparison can clarify
  capture                             or distort

  new behaviour ↔ new recognition     public discovery may occur years
                                      after emergence

  institutional failure ↔ central     distributed non-correction can
  conspiracy                          produce systemic harm without one
                                      command structure

  political usefulness ↔ common       actors can produce complementary
  intent                              effects for different reasons
---

These distinctions make the history more precise, not less serious.

---

## 📚 Sources & Further Reading

-   [CTV News: "'Montreal Massacre' threat forces media critic to cancel
    video game
    talk"](https://www.ctvnews.ca/canada/article/montreal-massacre-threat-forces-media-critic-to-cancel-video-game-talk/)
    --- contemporary October 2014 reporting on the threat against Anita
    Sarkeesian's Utah State University appearance, the École
    Polytechnique reference, security dispute, and contemporary
    descriptions of Gamergate.
-   [Alexis Chapelan: "Opposition to Political Correctness as
    Metadiscourse. Mapping the Topos of the 'Free Speech Crisis' in
    Western Right-Wing
    Discourse"](https://ibn.idsi.md/sites/default/files/imag_file/13-25_3.pdf)
    --- Discourse-Historical Approach to anti-PC rhetoric; useful for
    symbolic glue, transgressive bonding, self-victimisation,
    ideological glocalisation, and Jordan Peterson's multilayered
    legitimation strategy.
-   [Wikipedia: "École Polytechnique
    massacre"](https://en.wikipedia.org/wiki/%C3%89cole_Polytechnique_massacre)
    --- orientation source for the 1989 antifeminist mass shooting
    explicitly invoked in the 2014 Utah threat; use primary and
    scholarly sources for deeper historical work.
