...
```mermaid
flowchart LR
    A[Famous objectionable company]
...
flowchart TD
    A[Data sovereignty]
    B[US political risk]
    C[Military relationships]
    D[Procurement governance]
    E[Revolving doors]
    F[Vendor lock-in]
    G[Palestine / military ethics]
