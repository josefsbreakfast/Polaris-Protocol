...
The reuse of a known group name does not automatically establish continuity.
...
> Investigators linked the intrusion to a criminal access broker. No public evidence has established who ultimately purchased or used the access.
...
- or unknowingly provide material that another actor subsequently uses.
...
Institutional recovery may not end the incident for the people whose information was exposed.
...
- and whether the assessment was upgraded, downgraded, withdrawn, or excluded.
...
Use sparingly and only where the relevant evidentiary standard genuinely supports it.
...
- treating a criminal operator as proof there is no later state customer;
