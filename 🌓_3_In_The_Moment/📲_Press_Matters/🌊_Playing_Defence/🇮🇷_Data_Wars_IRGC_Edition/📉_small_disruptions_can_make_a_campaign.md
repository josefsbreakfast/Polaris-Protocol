...
Cyber defence is often imagined through a dramatic threshold.

The grid goes down.

The bank stops working.

The hospital system crashes.

The government disappears from the internet.

That model is too narrow.

A modern campaign can work through repeated, limited, deniable incidents that remain individually survivable but collectively expensive, destabilising, and hard to explain.

The relevant question is not only:

> Did one attack stop the country?
...
## 🧮 The Unit Of Analysis Is Not Always The Incident

One incident may look minor.
...
The campaign may exist in the pattern between them.

That pattern can include:

- repeated targeting of essential services;
- movement across several countries;
- movement across several sectors;
...
The individual event remains important.

It is not always the whole object.

---

## 🌧️ Accumulation Changes The Meaning

The first disruption may be absorbed.

The fifth may reveal a pattern.
...
- delay other work;
- exhaust specialist teams;
- increase insurance and recovery costs;
...
It may also succeed by consuming the buffers that made each earlier incident look small.

Those buffers include:
...
The next may arrive before that capacity has recovered.

Campaign effect can therefore emerge through **buffer depletion**:

```text
INCIDENT
→ FALLBACK
→ RECOVERY WORK
→ BACKLOG / FATIGUE / COST
→ NEXT INCIDENT ARRIVES
→ LESS CAPACITY AVAILABLE
```

The apparent smallness of an incident may be an output of successful containment rather than an intrinsic property of the attack.
...
It can also obscure what containment required.

A contained incident may still have caused:
...
- data exposure;
- financial cost;
- or months of remediation.

A water system that continues manually has not escaped harm.
...
Continuity is not costless merely because the public-facing service remained available.

Operators, clinicians, security staff, administrators, families, and affected people may be carrying the disruption in forms that the outage counter never records.
...
It can make governments hesitate.

It can divide agencies.

It can make journalists overclaim and then retreat.

It can encourage officials to say nothing.

It can leave affected people unsure whether they face:

- ordinary crime;
- state activity;
- insider misuse;
- commercial surveillance;
- or several overlapping threats.

That uncertainty can produce its own damage.

The person or institution does not know:

- who may have the data;
- what they want;
- whether the attack is over;
- whether future incidents are connected;
...
One customer may use several operators, brokers, or intermediaries.
...
## 💸 A Campaign Can Join Above Or Below The Operator

Technical similarity is not the only possible connective tissue.

Incidents may be joined through:

- a common operator;
- a shared access broker;
- a contractor or intermediary;
- a common commissioner or payer;
