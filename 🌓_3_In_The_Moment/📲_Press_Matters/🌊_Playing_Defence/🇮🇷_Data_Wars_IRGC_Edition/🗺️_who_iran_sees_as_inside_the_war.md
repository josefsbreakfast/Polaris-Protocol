...
- sanctions;
- intelligence;
- or support to an ally.

Iran does not have to accept those categories as descriptions of its own operational environment.

Its practical question may be simpler:

> Did this state attack Iran, enable attacks on Iran, protect the forces carrying them out, constrain Iran's ability to retaliate, or support the wider coalition sustaining the war?

That produces a wider map.

A state can insist that it is not formally at war while still appearing inside Iran's operational picture.

This distinction matters for cyber analysis because essential infrastructure may be selected for pressure according to an adversary's operational map, not the target government's preferred description of its role.

But three things must remain separate:
...
A state appearing inside Iran's war map does not mean every civilian system within that state becomes a lawful military objective.

The map in this node is therefore a **threat-exposure map**.
...
It is not merely a supporting state, host state, or defensive participant.

For Iranian strategic analysis, Israel sits at the centre of the war alongside the United States.

Its military, intelligence, government, energy, communications, transport, health, water, and financial systems therefore sit inside the highest-risk category for Iranian and Iran-linked cyber activity.

That does not give every one of those systems the same legal status.
...
US strikes, forces, bases, regional partnerships, intelligence architecture, logistics, and economic power place it at the centre of Iran's war map.

Iranian and Iran-linked cyber operations against the United States may therefore serve several functions at once:
...
- coercion;
- data theft;
- testing of exposed infrastructure;
- and pressure on civilian confidence.

The relevant US attack surface includes federal systems, defence, energy, water, transport, health, banking, telecommunications, and thousands of locally operated public utilities.

The distributed structure of US essential infrastructure matters.
...
- British aircraft have conducted coordinated defensive operations;
- British aircraft have intercepted Iranian drones and missiles;
- British forces have protected coalition bases and regional partners;
- the UK authorised US use of British bases for specific operations against Iranian missile capabilities;
- RAF Fairford and Diego Garcia have formed part of that support architecture;
- US aircraft have operated through British facilities;
- British naval and air assets have been deployed across the wider regional defence effort;
- and Britain has worked with regional partners to improve defence against Iranian drones and missiles.

The government has maintained that these actions do not amount to joining the broader offensive war against Iran.

Its legal position is that British actions are undertaken in individual and collective self-defence and are limited to dealing with Iranian attacks against Britain and regional partners.

That distinction matters legally.

It does not determine how Iran perceives British involvement.

The practical Iranian reading may instead be:

```text
British aircraft intercept Iranian weapons
+
British bases support US missions
+
British forces protect regional allies
+
British naval assets support the regional defence architecture
+
British infrastructure enables US military operations
=
Britain sits inside the hostile operational coalition
```

Britain can describe that as defensive support.

Iran can still perceive it as participation.

For this pack, Britain therefore belongs firmly inside the tracking perimeter.

The distinction that must be preserved is:

```text
Iran may perceive Britain as participating
≠
this pack determines Britain's legal belligerent status
```
...
Iran may understand that distinction.

It may nevertheless perceive the island as one operational geography containing military infrastructure used by states supporting the opposing campaign.

That creates layered exposure around:

- British sovereign bases;
- the Republic of Cyprus;
- civilian infrastructure adjacent to military facilities;
- ports;
- airports;
- energy;
- telecommunications;
- water;
- logistics;
- and systems supporting foreign forces.

The constitutional map and the operational threat map are not necessarily identical.

This is especially important for cyber analysis.
...
The relevant group includes states such as:
...
Some host foreign bases.

Some intercept Iranian weapons.

Some protect regional infrastructure.
...
- logistics;
- and systems supporting foreign bases.

The Gulf is not a secondary cyber theatre.

It is part of the central operational environment.
...
```text
power disruption
→ water-production pressure

water disruption
→ civilian and industrial pressure

telecommunications disruption
→ reduced operational visibility

transport disruption
→ repair and supply-chain pressure
```

The sectors cannot always be treated as independent targets.

Iran's explicit inclusion of water infrastructure in its August warning therefore matters beyond the water sector itself.

It creates a reason to give additional analytical weight to cyber incidents affecting:

- desalination;
- treatment facilities;
- pumps;
- industrial control systems;
- electricity supplying water infrastructure;
- telecommunications supporting remote control;
- and contractors operating those systems.
...
France has participated in:

- regional air defence;
- protection of French forces and citizens;
...
France therefore belongs inside the monitoring perimeter even where no public evidence places it in the same category as a direct attacking state.
...
Its role has included:

- political alignment through European and NATO structures;
- support to allied defensive activity;
...
- offensive strikes are not authorised;
- national forces are not participating;
- or foreign facilities operate under specific bilateral arrangements.
...
It is not by itself proof that Iran has designated the host country as an enemy state.
...
Their inclusion should depend on what they are actually doing.
...
- sanctions role;
- intelligence role;
- Iranian public statements about that role;
- and the date on which the assessment was made.

A country can move up or down the map as the war changes.

The map is a time series.
...
- Gulf states hosting or supporting US and allied forces;
...
- Canada;
- Japan;
- additional G7 states;
- NATO partners;
- maritime partners;
- sanctions participants;
- and other logistics or diplomatic supporters.

These states may presently be more relevant to:
...
- or lower-visibility cyber pressure

than to immediate disruptive attack.

This tiering is analytical.
...
Strategic ambiguity gives Iran flexibility.

A state may be:

- threatened publicly;
- targeted indirectly;
- treated as a host rather than an enemy;
- distinguished from foreign forces on its territory;
- pressured because it can influence another belligerent;
- or moved into a higher category after one operational decision.

The map is therefore dynamic.

The pack should avoid language such as:

> Iran considers all NATO states direct belligerents.

That is broader than the public evidence supports.
...
- credential theft;
- data exfiltration;
- disruption of weak public systems;
- attacks on local utilities;
- pressure on banks;
- operational-technology access;
- targeting of dissidents;
- proxy harassment;
- reconnaissance;
- or pre-positioning inside critical infrastructure.

That means the cyber perimeter should be wider than the kinetic target list.

A state may be too politically costly to strike openly but still attractive for deniable pressure.

There is also a difference between:

```text
Iran wants this state punished

Iran wants this state pressured
...
The analysis must keep two maps separate:
...
It cannot answer who conducted an incident.

This becomes particularly important after a public threat.

An Iranian warning against a state's water or energy infrastructure increases the contextual relevance of a later incident.
...
The correct analytical movement is:

```text
public threat
+
relevant later incident
=
higher investigative significance
...
Iran may perceive a country as contributing to the opposing war effort.

That does not make every civilian object in that country a lawful target.
...
coalition supporter
≠
civilian population loses protection
...
This prevents the pack from confusing:
...
> - [⚖️ When Attribution Controls The Public War-Crime Claim](./⚖️_when_attribution_controls_the_public_war_crime_claim.md) — *public attribution, legal significance, and evidentiary limits*
