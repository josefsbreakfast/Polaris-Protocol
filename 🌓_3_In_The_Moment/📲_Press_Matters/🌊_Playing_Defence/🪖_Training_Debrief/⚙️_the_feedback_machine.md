...
This node treats information flow as military capability. Operational experience only becomes institutional learning when evidence reaches the level capable of acting upon it, changes behaviour, and returns to reality for testing.

The purpose is not to make every frontline observation policy.

It is to stop valid negative feedback dying somewhere between the person who experiences the problem and the person authorised to change it.

> **The institution does not learn when the report is written.
> It learns when reality changes what happens next.**
