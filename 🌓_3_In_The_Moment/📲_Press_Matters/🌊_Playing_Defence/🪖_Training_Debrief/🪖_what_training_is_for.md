...
```mermaid
flowchart TD
    A["Individual competence"] --> H["Collective capability"]
    B["Equipment"] --> H
    C["Command"] --> H
    D["Communications"] --> H
    E["Logistics"] --> H
...
```mermaid
flowchart LR
    A["Personnel"] --> B["Individual competence"]
    B --> C["Collective training"]
    C --> D["Unit competence"]
    D --> E["Formation competence"]
    E --> F["Joint / allied competence"]
...
```mermaid
flowchart LR
    A["Doctrine / assumptions"] --> B["Exercise"]
    B --> C["Reality test"]
    C --> D["Failure / success"]
    D --> E["Lessons"]
    E --> F["Changed doctrine / equipment / training"]
    F --> B
```
...
```mermaid
flowchart LR
    A["Current operation"] --> B["Operational lesson"]
    B --> C["Instructor"]
    C --> D["Training changed"]
    D --> E["Next deploying cohort"]
```
...
```mermaid
flowchart LR
    A["Strategic task"] --> B["Required formation"]
    B --> C["Required collective competence"]
    C --> D["Training objectives"]
    D --> E["Live / synthetic / blended activity"]
    E --> F["Assessment"]
    F --> G["Readiness"]
```
...
```mermaid
flowchart TD
    A["Operational reality"] --> B["Lesson"]
    B --> C["Training"]
    C --> D["Changed behaviour"]
    D --> E["Exercise / operation"]
    E --> F["New evidence"]
    F --> B
```
