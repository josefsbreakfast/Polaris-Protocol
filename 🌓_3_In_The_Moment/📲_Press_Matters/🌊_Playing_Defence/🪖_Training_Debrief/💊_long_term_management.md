...
```mermaid
flowchart TD
    A["Strategic obligations"] --> B["Required functions"]
    B --> C["Required force"]
    C --> D["Required people"]
    C --> E["Required equipment"]
    C --> F["Required training"]
    C --> G["Required estate"]
    C --> H["Required sustainment"]
    D --> I["Cost"]
    E --> I
    F --> I
    G --> I
...
```mermaid
flowchart LR
    A["Exercise / operation"] --> B["Observation"]
    B --> C["Evidence"]
    C --> D["Lesson"]
    D --> E["Decision"]
    E --> F["Training / doctrine / equipment change"]
    F --> G["Retest"]
    G --> A
```
...
```mermaid
flowchart TD
    A["Define strategic functions"] --> B["Design force"]
    B --> C["Design force-generation system"]
    C --> D["Cost honestly"]
    D --> E["Prioritise"]
    E --> F["Implement"]
    F --> G["Exercise / operate"]
