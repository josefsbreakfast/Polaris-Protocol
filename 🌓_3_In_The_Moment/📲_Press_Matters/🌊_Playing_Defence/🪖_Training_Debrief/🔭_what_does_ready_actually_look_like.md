...
```mermaid
flowchart TD
    A["Required military function"] --> B["People"]
    A --> C["Equipment"]
    A --> D["Collective training"]
    A --> E["Command"]
    A --> F["Logistics"]
    A --> G["Medical"]
    A --> H["Intelligence"]
    ...
    C --> K["Fuel / ammunition"]
    E --> L["Communications"]
    F --> M["Industry / civilian support"]
    G --> N["Evacuation / hospitals"]
    D --> O["Instructors / estate"]
```
...
```mermaid
flowchart LR
    A["Strategic requirement"] --> B["Functional readiness"]
    B --> C["Force-generation system"]
    C --> D["Cost"]
    D --> E["Political affordability decision"]
