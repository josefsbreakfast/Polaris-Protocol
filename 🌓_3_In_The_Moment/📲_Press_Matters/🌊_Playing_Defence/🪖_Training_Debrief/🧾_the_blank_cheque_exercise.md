...
```mermaid id="gbrktc"
flowchart RL
    A["2076\nresilient capability"] --> B["2050\nindustrial / people / estate base"]
    B --> C["2035\nmature programmes"]
...
```mermaid id="f3yfn6"
flowchart LR
    A["Professional requirement"] --> B["Costed options"]
    B --> C["Treasury challenge"]
    C --> D["Political choice"]
    D --> E["Funded force"]
    E --> F["Explicit residual risk"]
```
...
```mermaid id="l2qmr4"
flowchart LR
    A["Ideal force model"] --> B["Costed force"]
    B --> C["Funded force"]
