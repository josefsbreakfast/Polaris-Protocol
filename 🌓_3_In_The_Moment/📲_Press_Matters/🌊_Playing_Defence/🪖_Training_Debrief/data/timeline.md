...
- **training** — how personnel were prepared individually and collectively;
- **operations** — what the Armed Forces were actually asked to do;
- **feedback** — what operations revealed and how institutions responded;
...
event:
  ...
  relationship_to_previous_policy:
    type: "implementation | modification | reversal | external_shock | unclear"
    detail:
  evidence:
    primary: []
    secondary: []
...
decision_chain:
  ...
  stages:
    - date:
      ...
      confidence:
  unresolved:
    - "When was the affordability problem first identified?"
    - "When was collective training first proposed as a saving?"
    - "Who proposed it?"
    - "Who approved it?"
    - "Who was informed?"
...
timeline_research:
  ...
  objective: >
    Construct a source-grounded chronology connecting British strategic
    planning, force design, resources, training, operations, institutional
    learning and political governance, with particular attention to the
    development of the 2026 Army collective-training dispute.
  period:
    core: "1980-2026"
    contextual: "1945-1979"
    high_resolution:
      - "2001-2014"
      - "2022-2026"
  required_layers:
    ...
    - "external_environment"
  source_priority:
    - "primary government and military documents"
    - "Parliament"
    - "official inquiries"
    - "NAO and independent scrutiny"
    - "contemporary professional research"
    - "specialist defence reporting"
    - "mainstream journalism"
    - "retrospective scholarship"
  extraction_rules:
    - "Record announcement and implementation separately."
    - "Record event date and public-disclosure date separately where they differ."
    - "Do not infer personal knowledge from office held."
    - "Do not infer causation from sequence."
    - "Distinguish established facts, contemporary claims, disputed claims and Polaris inference."
    - "Record uncertainty in date precision."
    - "Use exact dates where available."
    - "Link events to the strategic review whose assumptions they implement or challenge."
    - "Track recommendations across later rediscovery."
  ...
  prohibited_shortcuts:
    ...
    - "Personnel target equals trained deployable personnel."
    - "Event followed policy therefore policy caused event."
    - "Minister held office therefore minister knew."
    - "Multiple articles therefore multiple independent sources."
  output:
    - "master chronology"
    - "training-only chronology"
    - "recommendation and rediscovery loops"
