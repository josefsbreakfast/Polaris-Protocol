...
> **Purpose:** Track how successive UK governments have defined the strategic problem, designed the Armed Forces around it, funded that design, and implemented — or failed to implement — the resulting commitments.
...
1. What did government think Britain needed to defend against?
2. What did government expect the Armed Forces to do?
3. What force did that require?
4. What assumptions made that force appear sufficient?
5. What happened to personnel?
6. What happened to training and readiness?
7. What happened to equipment and infrastructure?
8. What did it cost?
...
assumption:
  proposition:
  introduced_or_visible_in:
  retained_through: []
  challenged_by:
  consequence_if_wrong:
  subsequent_policy_response:
  status_2026:
```
...
implementation_gap:
  ...
  outcome_date:
  gap:
  explanation_supported_by_sources:
  downstream_effects:
  later_policy_response:
  confidence:
```
...
research_instruction:
  ...
  rules:
    ...
    - "Do not infer causation solely from chronological proximity."
    - "Distinguish inherited conditions from decisions made by the government publishing each review."
    - "Distinguish strategic assumptions that later failed from decisions that were unreasonable on contemporary evidence."
    - "Record disagreement between government, services, Parliament, auditors and scholars."
    - "Prefer primary documents for what government promised."
    - "Prefer audit and implementation evidence for what actually happened."
  ...
  priority_output:
    ...
    - "chronology"
    - "recurring recommendation crosswalk"
    - "assumption ledger"
  ...
  stop_condition: >
    ...
    competing explanations for later assessment.
```
...
- Has Britain repeatedly expanded strategic ambition faster than sustainable force capacity?
- Which enabling capabilities have repeatedly been vulnerable during savings exercises?
- Has collective training historically been protected or treated as adjustable expenditure?
- When force size falls, does training demand fall proportionately?
- Which Iraq/Afghanistan lessons survived into later force design?
- Which were subsequently lost or made difficult to sustain?
- How often have later reviews rediscovered earlier recommendations?
- Which assumptions about warning time, allies, technology and mobilisation repeatedly underpin reductions?
- Does Britain preserve platforms more reliably than the human systems required to use them?
- Is the present £30m dispute genuinely anomalous, or an unusually visible example of a recurring budgeting mechanism?

**Do not answer these questions until the evidence has been assembled.**
