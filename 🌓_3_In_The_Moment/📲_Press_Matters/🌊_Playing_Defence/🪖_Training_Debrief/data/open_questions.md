...
- skill decay;
- team cognition;
- live versus synthetic training;
- force generation;
- mobilisation;
...
- sensitive force-generation detail;
- intelligence;
...
- [ ] Were estate savings considered?
- [ ] Were vacancies or recruitment assumptions relevant?
- [ ] Were other Army activities considered?
...
- [ ] Does the reported ~90-person threshold apply universally?
- [ ] Which formations are exempt?
- [ ] Which exercises are cancelled, postponed, reduced or redesigned?
...
- [ ] What reforms have senior Army leaders wanted but been unable to implement?
- [ ] What training changes have been requested repeatedly?
- [ ] Which instructor or rank groups are current bottlenecks?
- [ ] Where is training estate most constrained?
...
- [ ] If so, why?
- [ ] Which naval activities are protected or structurally harder to cancel?
...
- [ ] Are there joint instructor pools that could be expanded?
- [ ] Could estate be shared more effectively?
...
- [ ] At what scale?
- [ ] For what duration?
- [ ] With how many simultaneous commitments?
- [ ] Under what assumptions about US support?
- [ ] Under what assumptions about NATO reinforcement?
- [ ] What happens without air superiority?
- [ ] What happens with contested maritime access?
- [ ] What happens if CASEVAC is delayed?
- [ ] What happens under severe cyber disruption?
- [ ] What happens if conflict lasts years rather than months?
...
- [ ] What instructor capacity?
- [ ] What equipment?
- [ ] What reserve model?
- [ ] What would be joint?
- [ ] What would remain service-specific?
- [ ] What would the service voluntarily stop doing?
- [ ] What capability would it transfer elsewhere?
...
- [ ] What evidence exists of tactical feedback failing to reach strategic levels?
- [ ] What evidence exists of strategic constraints being poorly understood tactically?
- [ ] How are dissenting professional views recorded?
- [ ] What protections exist for uncomfortable lessons?
- [ ] Which Iraq/Afghanistan lessons were retained?
...
- [ ] How does MOD distinguish operational sensitivity from reputational sensitivity?
- [ ] How quickly does formerly sensitive material get declassified?
- [ ] Could more redacted lessons material safely be published?
...
- [ ] How does training affect casualty prevention?
- [ ] What is knowable empirically about avoided casualties?
- [ ] What personnel consequences follow chronic under-training?
...
- [ ] What can legally/administratively be moved between capital and operating expenditure?
- [ ] How are in-year savings allocated?
- [ ] Does budget flexibility systematically make training more vulnerable?
- [ ] Is £30m unusual or typical as an in-year savings requirement?
...
- [ ] How did *The Times* frame the issue?
- [ ] How did *The Telegraph* frame it?
- [ ] Did the right-of-centre press sustain the story?
- [ ] Did current favourable coverage of Healey affect attribution?
- [ ] Did mainstream coverage mention earlier parliamentary questions?
- [ ] Did reporting distinguish collective from individual training?
...
- [ ] Which were most clearly falsified?
- [ ] How often did implementation diverge from the stated force model?
...
priority:
  critical: >
    Answer materially changes the assessment of the current £30m decision,
    ministerial responsibility, readiness risk or proposed remedy.
  high: >
    Important to the cluster's central systems argument or historical
    interpretation.
  medium: >
...
research_status:
  ...
  - "requires_expert_interpretation"
...
open_questions_research:
  ...
  file: "data/open_questions.md"
  objective: >
    Maintain an explicit, prioritised and source-aware register of unresolved
    questions arising from research into British military training,
    readiness, force design, governance and the 2026 Army collective-training
    dispute.
  question_classes:
    public_record:
      description: >
        Questions likely answerable through existing public documentation,
        parliamentary records, official statistics, audit, published
        contracts or credible reporting.
      default_action: "research further"
    expert_scholarship:
      description: >
        Questions requiring specialist literature or professional
        interpretation rather than simple factual retrieval.
      default_action: "conduct evidence review"
    government_clarification:
      description: >
        Questions concerning internal decisions, risk acceptance, briefings,
        funding negotiations or institutional rationale not established by
        the public record.
      default_action: "preserve as governance question"
    probably_not_public:
      description: >
        Questions whose answer is likely classified, operationally sensitive,
        legally protected or otherwise unavailable in legitimate public
        sources.
      default_action: "record boundary and do not speculate"
  priority_rules:
    critical:
      - "Changes assessment of current training decision."
      - "Changes attribution of responsibility."
      - "Changes assessment of readiness risk."
      - "Changes immediate policy recommendation."
    high:
      - "Material to longitudinal systems analysis."
      - "Material to training effectiveness."
      - "Material to future force design."
    medium:
      - "Useful contextual or comparative evidence."
    low:
      - "Interesting but non-essential."
  workflow:
    - "Generate questions from evidence gaps in other data files."
    - "Classify question by evidence route."
    - "Assign priority."
    - "Record current evidence and confidence."
    - "Attempt proportionate research."
    - "Update best answer without overstating certainty."
    - "Escalate to expert/government category where public research reaches its limit."
    - "Close questions when answered or no longer relevant."
    - "Do not erase resolved questions; retain outcome for provenance."
  methodological_rules:
    - "Absence of evidence is not evidence of absence unless the evidential context supports that inference."
    - "Plausibility is not proof."
    - "Do not infer personal ministerial knowledge from office."
    - "Do not infer classified capability from public silence."
    - "Do not treat repeated media claims as independent confirmation."
    - "Distinguish factual uncertainty from interpretive disagreement."
    - "Preserve competing explanations where evidence remains incomplete."
    - "Stop searching when further specificity would require inappropriate reconstruction of sensitive operational information."
    - "Record when a question is genuinely unanswerable from legitimate public sources."
  cross_file_inputs:
    - "data/source_bank.md"
  ...
  end_state: >
    The file should make clear not only what remains unknown, but whether
