...
```mermaid
flowchart TD
    A[Unresolved abuse archive] --> B[Estate / files / assets / liabilities]
    B --> C[Partial disclosure / redaction / leak]
    C --> D[AI indexing / entity linking / association graphs]
    D --> E[Elite panic / legal risk / reputation markets]
    E --> F[Lawyers / PR / media / platforms / political actors extract value]
    F --> G[Public distrust / survivor retraumatisation / institutional pressure]
    G --> H[New demand for disclosure]
    H --> C
```
