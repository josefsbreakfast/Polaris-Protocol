...
People ask questions about their life.
...
This is the whole fucking point of clearance.
...
```text
VETTING
What risks require assessment?

ELIGIBILITY / CLEARANCE
For what categories of sensitive access
may this person be eligible?

AUTHORISATION
What is this role actually permitted to access?

NEED-TO-KNOW
Does this person need this particular information?

ACCESS CONTROL
Can they technically or physically obtain it?

CONTINUING ASSURANCE
Have relevant circumstances changed?
```

Those questions interact.
...
- using an inappropriate device;
- misunderstanding handling requirements;
- being unusually exposed to attempted elicitation;
- having accounts that have been compromised;
- travelling somewhere that changes their threat exposure;
- acquiring a relationship that creates new reporting requirements;
- possessing access they no longer need;
- or simply making a mistake.

None of these propositions means:
...
A President, minister, chief executive or senior official may sincerely
say:
...
Security assurance still has a job.

---

## 🧬 Person + Access + Environment

A useful way to think about personnel security is not:
...
Personnel security is therefore **relational**.

The same person may represent a very different security proposition in:

- an ordinary administrative office;
- a senior political office;
- a classified briefing environment;
- a diplomatic environment;
- or an institution facing intensive foreign collection.

Change the role.

Change the information.

Change the threat environment.
...
- which relevant risks have been identified;
- what restrictions are necessary;
- what exceptions have been granted;
- what mitigations or compensating controls apply;
- and what requires continuing review.

That matters before an incident.

It matters even more afterwards.

A security investigation needs some way of comparing:
...
What should they have been able to see?

Which devices should have been present?

Which systems should have accepted their credentials?

Which restrictions should have applied?

Which exceptions had actually been authorised?

What should have been logged?

Which pathways should, in theory, have been impossible?
...
But the reverse mistake is equally silly:
...
> **Can we prove something terrible happened?**
...
NO CLEARANCE
      ↓
PERSON WAS A FOREIGN AGENT
```

What we **can** ask is:

```text
EXPECTED PROCESS NOT COMPLETE
        ↓
DO NOT ACCUSE PERSON
        ↓
IDENTIFY WHAT ASSURANCE IS MISSING
        ↓
IDENTIFY WHAT ACCESS EXISTED
        ↓
IDENTIFY COMPENSATING CONTROLS
        ↓
IDENTIFY WHO ACCEPTED THE RESIDUAL RISK
```

That produces rather better questions:

- What security process would ordinarily have occurred?
- Which parts had been completed?
- Which had not?
- What risks would ordinarily have been assessed?
- What access existed meanwhile?
- What restrictions were imposed?
- What compensating controls existed?
- Was the deviation formally documented?
- Who authorised the arrangement?
- Who accepted the residual risk?
- On what basis?
- How long did it continue?
- Was it periodically reviewed?
- Was it revisited as responsibilities or access changed?

That is where the interesting reporting begins.
...
> **"Interim" describes status. It does not describe controls.**
...
> Covering which systems and spaces?

> Subject to what supervision?
...
## 👀 What Access Actually Came With The Job?

Another press simplification is:

> **Did she have access to classified information?**

That is an important question.

It is not necessarily a sufficiently precise one.

Access can mean different things.
...
- access a database;
- attend a meeting;
- enter a sensitive physical space;
- see material displayed on a screen;
- overhear a discussion;
- manage somebody's schedule;
- handle communications;
- know who is meeting whom;
- observe changes in routine;
- see drafts before publication;
- know what questions senior officials are asking;
- or understand which issues are suddenly consuming their attention.
...
TECHNICAL ACCESS
what systems permitted

PHYSICAL ACCESS
where the person could go

OBSERVATIONAL ACCESS
what the person could see or hear

CONTEXTUAL ACCESS
what the position allowed them to infer
```

Not all of those necessarily involve classified information.

Not all require the same controls.

But several can produce intelligence value.
...
Some of those things may be entirely irrelevant.

Some may require assessment.

Some may require controls.

The purpose of a security process is partly to determine which is which.
...
NEED-TO-KNOW
        ↓
TECHNICAL / PHYSICAL ACCESS CONTROLS
        ↓
COMPARTMENTATION
        ↓
MONITORING / LOGGING
...
That is not intended as a universal government workflow.
...
foreign collection requirement
        ≠
foreign operation
...
- establishing secure communications expectations;
- identifying risky interfaces;
- providing clear reporting channels;
- preparing people for suspicious approaches;
- reducing unnecessary exposure;
- ensuring relevant concerns can be assessed professionally;
...
Being manipulated does not mean recruited.

Being surveilled does not mean knowingly providing information.

That is why professional security is preferable to suspicion-by-vibes.
...
- or being targeted because of what their role exposes them to.

The person can therefore be simultaneously:

**an insider security risk**

and

**a victim of somebody else's operation.**
...
## ⚖️ This Is Not A Witch Hunt

This distinction should be straightforward:
...
Start with the role and threat.
        ↓
...
The more useful institutional question may be:

> **Who decided that the organisation could accept this deviation?**
...
- Did the exception have an expiry point?
- Was it renewed?
- Was the person's access expanding while the assurance position
    remained static?
- Who was responsible for noticing if a temporary arrangement quietly
...
WHAT SHOULD THEY HAVE ACCESSED?
        ?
...
That uncertainty expands the investigative problem.

It does **not** mean:

> **the uncleared person caused the incident.**
...
- What clearance, vetting or personnel-security process was required
    for the role?
- Was that requirement mandatory, customary or discretionary?
- Which stages had been completed?
- Which remained outstanding?
- Was temporary or interim access formally authorised?

### Access

- What was the scope of that access?
- What information did the role expose the person to?
- Which systems could they use?
- Which meetings could they attend?
- Which physical spaces could they enter?
- What observational or contextual access came with the role?
- What need-to-know restrictions applied?
- What devices and communications systems were permitted?

### Exception And Mitigation

- Who authorised any deviation from the ordinary process?
- Under what authority?
- What compensating controls were imposed?
- Were those controls documented?
- Were they actually enforced?
- How long was the arrangement intended to last?
- How long did it actually last?
- Who accepted the residual risk?
- Was the exception periodically reviewed?

### Incident And Review

- Did the person's role or access change during the period?
- Did the external threat environment change?
- Were any relevant security incidents identified?
- If concerns subsequently arose, was technical compromise considered
    alongside deliberate disclosure?
- Could investigators reconstruct what access and controls actually
    existed at the relevant time?

And perhaps most importantly:

> **What security assurance did the institution possess that allowed it
> to conclude this arrangement was acceptable?**

That question neither convicts nor exonerates the individual.

It asks the institution to explain its security architecture.

---

## 🪪 The Whole Fucking Point

Clearance is not a halo.

It is not a scarlet letter.

It is not a personality test.

It is not proof that somebody is safe.
...
```text
"We have assessed and appropriately controlled
the risks associated with her access."
```
...
```text
"We found no evidence she did anything wrong."
```

and:

```text
"We can demonstrate that the required
security architecture was in place."
```

The first proposition may be completely true.
...
**That is the whole fucking point of clearance.**
