...
This node sets out a **field-usable method** for groups who suspect they are being subjected to **cluster-targeted behavioural shaping** — what Polaris calls a **differential reality loop**.
...
- Use “general audience” signals (news, platform changes, messaging, policy nudges) that only *hit hard* for a specific cluster;  
...
You are not trying to find a “smoking gun”.  
...
> “Something systemic is happening to us that is not happening to everyone else.”

---

### 3.1 Signature A — Platform Differential  
...
- Multiple members reporting that **content about certain topics feels “heavy”, “laggy”, or “buried”** compared to other themes.  
...
### 3.2 Signature B — Cross-Context Friction  

**Question:**  
Does friction follow the group across **multiple arenas**, not just one platform?

You are looking for recurring “drag” in places that should be independent:
...
- Repeated administrative “mistakes” that all push in the same direction (delay, confusion, missed deadlines).  
...
### 3.3 Signature C — Isolation Effect  
...
- Friends or professionals say: “I don’t see what you’re talking about,” even when shown partial evidence.  
- Journalists express interest but then drop the story because it feels “too fuzzy” or “too hard to stand up”.  
- Complaints are interpreted as mental health issues rather than technical or structural concerns.  
- When the group collects examples, outsiders perceive them as “coincidences” rather than a pattern.
...
### 3.4 Signature D — Anomalous Convergence  
...
- Multiple organisers feel that “everything was suddenly harder” or “energy dropped off a cliff” at a particular moment.  
...
You’re not trying to “prove bias” to a court; you’re trying to see whether **only your group hits the wall**.
...
- phrases used to dismiss concerns (“you’re overthinking it”, “everyone feels like that online”, “you’re too emotional”),  
...
- Show that a pattern is **real and shared**, not just one person’s distress.  
...
- Provide structured material to:
  ...
  - legal advocates,  
  - future inquiries.  
- Give the group language to describe what is happening without collapsing into “it’s all rigged”.
...
> “Here is a documented pattern of differential reality that needs explanation.”
...
- **Name it** explicitly:  
  “We are in a differential reality loop; our experience is structurally different.”  
...
The point is not to “win” against the Frankenstack.  
...
🧠 🧿 🌊 📡 ✂️ — diagnostic node for mapping invisible pressure fields, documenting asymmetry, and cutting through narrative fog to stabilise survivor and activist organising.
