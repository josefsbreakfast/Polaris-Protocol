...
```mermaid
flowchart TD
    A["Step 1: What I Cannot Know"] --> B["Step 2: What the System Typically Does"]
    B --> C["Step 3: Population-Level Rates"]
    C --> D["Step 4: My Situation Compared to Those Rates"]
    D --> E["Step 5: Trauma Echo vs Current Context"]
    E --> F["Step 6: Grounded Interpretation"]
```
