...
An ally may be described with careful euphemism.

An adversary may be described with absolute certainty.

A familiar democracy may be presumed restrained because formal safeguards exist.

An openly authoritarian state may be treated as responsible for every suspicious event merely because the conduct would fit its interests.

None of these approaches produces a trustworthy comparison.
...
It is not to declare that every state is secretly identical beneath the paperwork.

It is not to compare one country’s documented lethal operations with another country’s merely theoretical technical capability and then call the result balanced.

A useful comparison asks narrower questions.
...
A state may possess a capability.

An institution may have deployed it.

The observed harm may still have arisen through another route.
...
A finding about one administration should not become an eternal national characteristic.
...
It should not therefore be treated as an extension of that state.

A religious community may be affected by a government’s conduct.

It should not be made responsible for that government.

A nationality is not a security classification.

An ethnicity is not evidence of political alignment.
...
Fragmentation does not prove central coordination.

It does not remove responsibility either.
...
A reform announced by a later government may not have altered operational behaviour.

A historical pattern remains relevant, but it should not be silently presented as current fact.
...
These nodes should be used together.

The question set builds the instrument.

The confidence scale governs how strongly its findings may be stated.

The capability-and-intent node protects the evidentiary chain.
