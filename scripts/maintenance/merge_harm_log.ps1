...
Notes:
- I used **four backticks** around the embedded log to avoid conflicts if your harm log contains triple backticks.
- Make sure the file is saved with the **`.ps1`** extension (not `.md`).
- If PowerShell blocks it:  
  `Set-ExecutionPolicy -Scope CurrentUser -ExecutionPolicy RemoteSigned`

Ping me if you want me to scan your wrapper too, just to make sure the call-and-push flow is tight.
