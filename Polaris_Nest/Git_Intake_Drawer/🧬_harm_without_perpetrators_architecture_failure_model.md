...
## 🛰️ Orientation  
Most institutional failures are not caused by malice but by architecture.  
When systems break, human experiences resemble interpersonal harm even when no malicious actor exists.
...
## 🌌 Constellations  
🧬 ⚖️ 🧠 🛰️ — systemic ethics, design responsibility, cognition, information drift.

---

## ✨ Stardust  
architecture failure, structural harm, federated governance, opacity, inquiry logic, nonmalicious harm, coercive patterns
