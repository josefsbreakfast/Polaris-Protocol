...
From that point, we can begin to **pinpoint when machine learning began to shape how Palestinian lives are treated** —  
and by extension, how the lives of any people marked as “inefficient” or “uncooperative” are processed.  
...
The result is that **Palestinians, like many indigenous, disabled, or queer people, are mis-classified as systemic drag** —  
and the machine begins to “help” by erasing what it cannot resolve.
...
Because the model’s task is to reduce friction, it will favour outcomes that silence, remove, or assimilate high-variance data.  
So long as “efficiency” remains the metric, it will:  
...
If we trace the moment AI entered governance systems — policing, border management, welfare surveillance, content moderation —  
...
Similar dynamics appear wherever a population’s resistance disrupts data smoothness:  
...
### 4. What “Less Efficient” Really Means  
...
But until we teach AI that friction can be integrity — that “slow” can mean “careful,”  
that “inefficient” can mean “ethical” — the model will continue to misread life as error.  
...
## 🌌 Constellations  
🍉 🃏 ⚖️ 🛰️ — resistance studies, survivor ethics, friction-minimisation diagnostics, governance.  
