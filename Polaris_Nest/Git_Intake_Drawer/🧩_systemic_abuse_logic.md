...
## 🛰️ Orientation  
This node explains the operating logic of systems that consistently produce:
...
## ✨ Key Features  
- **Harm as procedural output**  
- **Abuse distributed across the system, not located in individuals**  
- **Role coercion:** people incentivised into compliance  
- **Layered containment mechanisms**  
...
- abusers are expected to be protected  
- truth is expected to distort  
...
- procedural  
- incentivised  
- justified through policy  
- enacted through multiple small decisions  

This creates plausible deniability for each participant:

- “I was following protocol.”  
- “That fell outside my remit.”  
...
- prioritising appearance over truth  
...
- questioning culture  
- naming the abuse  
- refusing to sacrifice someone  
- being morally consistent  

The system shapes behaviour through **job logic**, not ethics.
...
- claims of “balance” or “unity”  
- moral panic around dissent  
...
This is governance through fog.
...
2. **Silence:** people avoid risk by not speaking  
3. **Obedience:** compliance becomes self-protection  
4. **Throughput:** the system continues unchallenged  

This cycle repeats until either:

- a survivor speaks,  
- an outsider witnesses,  
- a whistleblower leaks,  
- or the system’s legitimacy collapses under its own contradictions.
...
- complaint-handling structures  
- HR policy  
- referral pathways  
- risk registers  
- moderation guidelines  
- safeguarding miscategorisation  
- disciplinary processes  
- “civility” rules  
- time delays  
- documentation gaps  

The process itself becomes the weapon.

You never meet the villain —  
the villain is **the workflow**.
...
- principled  
- boundary-setting  
- non-compliant with toxicity  
- inconvenient for leadership narratives  
- too good at their jobs  
- unwilling to flatter upwards  
...
- refusing shame  
- forming witness networks  
- analysing the incentive architecture  
...
## ✨ Stardust  
harm-as-throughput, workflow cruelty, administrative violence, structural selection logic, reputation inversion, fog governance, procedural extraction.
