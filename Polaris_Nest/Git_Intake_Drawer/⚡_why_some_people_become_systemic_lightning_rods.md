...
```mermaid
flowchart TB
    A["Systems Under Stress"] --> B["Search for Causes"]
    B --> C["Bias / Heuristics"]
    C --> D["Identify a 'Difficult' Person"]
    D --> E["Over-interpretation"]
    E --> F["Increased Scrutiny / Escalation"]
    F --> G["Entrenched Lightning Rod Status"]
```
