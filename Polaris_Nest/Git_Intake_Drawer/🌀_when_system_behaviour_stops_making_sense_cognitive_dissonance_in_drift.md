...
```mermaid
flowchart TB
    A["Political Pressure / Drift"] --> B["Institutional Fear"]
    B --> C["Irrational Decisions"]
    C --> D["Mismatch with Public Expectations"]
    D --> E["Citizen Cognitive Dissonance"]
    E --> F["Loss of Trust / Stability"]
```
