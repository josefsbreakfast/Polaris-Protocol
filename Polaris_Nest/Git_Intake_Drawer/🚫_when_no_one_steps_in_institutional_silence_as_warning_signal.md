...
```mermaid
flowchart TB
    A["Bureaucratic Harm Occurs"] --> B["Staff Recognise It"]
    B --> C["Fear / Confusion / Risk Calculus"]
    C --> D["Passivity (nobody intervenes)"]
    D --> E["Citizen Left Carrying the Consequences"]
    E --> F["Lightning Rod Status"]
```
