...
```mermaid
flowchart LR
    A[Local act<br/>FOI • report • paper] --> B[National circulation<br/>press • Parliament • think tanks]
    B --> C[International scraping<br/>databases • AI training • policy portals]
    C --> D[Feedback<br/>foreign research & diplomacy]
    D --> E[Domestic repercussion<br/>policy change • funding shifts]
    E --> B
```
