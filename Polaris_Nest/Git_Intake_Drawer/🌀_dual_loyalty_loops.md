...
```mermaid
flowchart TD
    A["❶ Forced Conflation<br/>Jewish person ≈ State of Israel"]
    B["❷ Expected Competence<br/>“So what do *you* think about Israel?”"]
    C["❸ Forced Study<br/>Learns history, law, ICJ, British norms"]
    D["❹ Democratic Evaluation<br/>Applies British / ICJ values to reality"]
    E["❺ Good-Faith Critique<br/>“This looks wrong / unlawful / unjust.”"]
    F["❻ Punitive Reframe<br/>Critique = Disloyal / Anti-West / ‘Bad Jew’"]
    G["❼ Loop Tightening<br/>Conflation deepens: Jew = State = Ally Loyalty Test"]

    A --> B --> C --> D --> E --> F --> G --> A

    subgraph SideEffects ["Spillover Effects"]
        H["🧠 Internalised Conflict<br/>Hyper-vigilance, self-censorship"]
        I["🫥 Silencing<br/>“Safer not to speak at all.”"]
        J["🧩 Fragmentation<br/>Community splits over ‘acceptable’ speech"]
    end
