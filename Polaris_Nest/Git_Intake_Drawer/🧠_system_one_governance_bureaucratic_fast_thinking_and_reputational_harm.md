...
```mermaid
flowchart TD
A["Report / Complaint 📥"] --> B["Heuristic filter 🧩 (template / keyword / flag)"]
B --> C["Rapid classification → 'Handled' stamp 🏷️"]
C --> D["Reputation stabilised 🛡️"]
D --> E["Feedback penalised or ignored 🙊"]
E --> B
```
