...
```mermaid
flowchart TB
    ES[Ein Sof / אֵין סוֹף\nlimitless source / beyond capture]

    subgraph A[מוֹחִין / Mochin\norientation, perception, pattern]
        K[Keter / כֶּתֶר\nintention / crown / what is being served]
        Ch[Chokhmah / חָכְמָה\nflash / seed / possibility]
        B[Binah / בִּינָה\ncontainer / structure / discernment]
    end

    subgraph M[מִידּוֹת / Middot\nethical-emotional movement]
        C[Chesed / חֶסֶד\nexpansion / generosity / love]
        G[Gevurah / גְּבוּרָה\nlimit / restraint / force]
        T[Tiferet / תִּפְאֶרֶת\nintegration / proportion / beauty]
        N[Netzach / נֵצַח\nendurance / drive / continuity]
        H[Hod / הוֹד\nyielding / acknowledgement / humility]
    end

    subgraph D[Manifestation\nchannel, speech, world]
        Y[Yesod / יְסוֹד\nfoundation / bond / transmission]
        Ma[Malkhut / מַלְכוּת\nDibbur / דִּבּוּר\nworld-facing speech / enacted reality]
    end

    ES -. cannot be captured .-> K
    K --- Ch
    Ch --- B
    B --- C
    B --- G
    ...
    H --- Y
    Y --> Ma
    Ma -. feedback from world .-> Y
    Ma -. feedback from world .-> M
    M -. integration pressure .-> A
```
