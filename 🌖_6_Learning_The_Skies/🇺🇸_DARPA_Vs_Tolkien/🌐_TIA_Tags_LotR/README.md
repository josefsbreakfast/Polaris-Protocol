...
There is no requirement to know the eventual node structure in advance.

When the text produces another:

> **BRO. TIA WOULD TAG THE FUCK OUT OF THIS.**
...
Not an instruction to stop doing security.
...
The United States has merely encountered the professor.
