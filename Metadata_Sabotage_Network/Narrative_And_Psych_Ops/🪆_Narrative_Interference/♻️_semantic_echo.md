...
```mermaid
flowchart LR
A["Harmful phrase spoken 💬"] --> B["Institutional repetition 🗂️"]
B --> C["Documented descriptor 🧾"]
C --> D["System replication 🔁"]
D --> E["Policy or public uptake 🏛️"]
E --> F["Credibility distortion 🪞"]
F --> A["Echo renewed by citation 🔊"]
```
