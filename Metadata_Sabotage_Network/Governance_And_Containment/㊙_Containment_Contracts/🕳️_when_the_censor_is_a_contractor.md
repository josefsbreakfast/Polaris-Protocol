...
```mermaid
flowchart LR
    Client[State / Corporate Client]
    Contractor[Hack-for-Hire Operator]
    Target[Journalist / Opponent]
    Reporter[Investigator / Media]
    Lawfare[Reputation & Legal Arm]
    Admin[Administrative Leverage]
    Archive[Mirrors & Archives]

    Client --> Contractor
    Contractor -->|intrusion / data theft| Target
    Reporter -->|exposes| Contractor
    Lawfare -->|takedown / defamation| Reporter
    Admin -->|visa / OCI revocation| Reporter
    Reporter --> Archive
```
