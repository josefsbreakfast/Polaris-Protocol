...
> “Only brief me on issues that will escalate into big problems if I don’t act.”
...
Result:  
**Issues that “end” locally but cause wider harm elsewhere are silently filtered out.**

The robot did not know you meant *“don’t let this mutate into something worse later.”*
...
## 🏛️ Why This Is Especially Risky in Government
...
- **Diffused responsibility:** “the system didn’t flag it”  
...
## ⚠️ Why Safety Tuning Doesn’t Fix This
...
## 🧪 Illustrative Scenario (Non-Hypothetical)

A minister asks for a briefing filter:

> “Only surface issues that will become serious problems if not addressed.”
...
- a data-sharing practice that “works” but erodes trust long-term  
...
## 🪜 The Slippery Slope of Delegated Judgment
...
4. Losing the habit of asking “what’s missing?”  

This is moral deskilling by automation.

---

## 🧠 Stress Makes This Worse (Not Better)
...
## 🧨 Why This Is Not Solved by “Human-in-the-Loop”
...
…will not reliably catch what was never surfaced.
...
## 🧰 Minimal Safeguards (If Use Is Unavoidable)

Any governance deployment must include:

### 1. Explicit Downstream-Harm Prompts  
> “Include issues that resolve locally but cause harm elsewhere or later.”

### 2. Omission Audits  
Regular reviews asking:
- What *didn’t* appear in briefings?
- Who raised it later?
- Why was it filtered?

### 3. Adversarial Prompting  
Deliberately test:
- “What would a critic say is missing?”
- “What would future inquiries ask about this period?”
...
## 🧱 Historical Analogy (For Institutional Readers)

This failure mode mirrors:
- early actuarial risk models ignoring moral hazard  
- cost–benefit analyses that externalised suffering  
...
## 🔍 Diagnostic Questions for Review Panels

Ask, explicitly:

- What harms were excluded because they “resolved”?
...
You didn’t realise you’d stopped checking the exits.
