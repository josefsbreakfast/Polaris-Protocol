...
```mermaid
flowchart LR
    A["Low-Threshold Concern"] --> B["Prevent Referral<br>(just in case)"]
    B --> C["Risk Categorisation<br>(partial / subjective)"]
    C --> D["Cross-System Metadata Echo"]
    D --> E["Community Distrust<br>Fear of Visibility"]
    E --> F["Social Fragmentation<br>(atomisation)"]
```
