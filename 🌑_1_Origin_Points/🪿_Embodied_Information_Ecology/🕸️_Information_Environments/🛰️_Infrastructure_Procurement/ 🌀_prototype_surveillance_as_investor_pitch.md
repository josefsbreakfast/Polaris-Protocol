...
```mermaid
flowchart TD
  A[Citizen / Community Actor] --> B[Data Exhaust\nplatforms, services]
  B --> C[Aggregation & Federation]
  C --> D[Scoring Models\nrisk + narrative leverage]
  D --> E{Selection & Intensity}

  E -->|Low| F[Passive Monitoring]
  E -->|Medium| G[Soft Containment\nfriction, deprioritisation]
  E -->|High| H[Hard Containment\nstress, disruption]

  F --> I[Operational Metrics]
  G --> I
  H --> I

  I --> J[Oversight Review\nisolated incidents]
  J --> K[No Pattern Detected]
