...
```mermaid
flowchart LR
    A["Normal Interaction"] --> B["Institutional Pressure / Panic"]
    B --> C["Cognitive Shortcuts"]
    C --> D["Assign Category<br>(risk / identity / behaviour)"]
    D --> E["Decisions Based on Category"]
    E --> F["Loss of Personhood"]
```
