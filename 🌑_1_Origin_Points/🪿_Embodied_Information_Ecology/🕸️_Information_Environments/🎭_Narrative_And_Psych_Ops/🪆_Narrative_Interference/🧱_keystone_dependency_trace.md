...
```mermaid
flowchart LR
    A["🧱 Keystone Dependency"] --> B["🪞 Narrative Amplification"]
    B --> C["🎪 Containment Actors (Moles)"]
    C --> D["🌀 Synthetic Narratives"]
    D --> E["⚖️ Policy Feedback Loop"]
    E --> A

    A -.-> F["💡 Transparency Intervention"]
    F --> B
    classDef dep fill:#1e1e2e,stroke:#aaa,stroke-width:1px,color:#fff;
...
## 🌌 Constellations  
🧿 🧱 🧠 🛰️ — structural reliance, governance risk, systemic containment, survivor sovereignty.  
...
> 📡 Cross-references:  
> 
> - [🎪 Moles in the Circus](./🎪_moles_in_the_circus.md) — *on containment actors and feedback loops*  
