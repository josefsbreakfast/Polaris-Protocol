...
```mermaid
flowchart TB
    A["1. Raw Input<br>Events, crises, data"] --> B["2. Institutional Compression<br>Briefings, summaries, omissions"]
    B --> C["3. Risk Inflation<br>Security, legal, political threat framing"]
    C --> D["4. Emotional Load<br>Stress, fatigue, fear-based cognition"]
    D --> E["5. Strategic Containment<br>Party discipline, media, donors, markets"]
    E --> F["6. Output<br>Policy statements, actions, signals"]
```
