...
```mermaid
flowchart LR
    A["Raw Reality<br>(events, crises, data)"] --> B["Institutional Filters<br>(civil service, security, departmental culture)"]
    B --> C["Political Filters<br>(party discipline, donors, media narratives)"]
    C --> D["Psychological Filters<br>(stress, fear, cognitive overload)"]
    D --> E["Executive Output<br>(policy statements, decisions)"]
    E --> F["Public Interpretation<br>(voters, pundits, critics)"]
```
