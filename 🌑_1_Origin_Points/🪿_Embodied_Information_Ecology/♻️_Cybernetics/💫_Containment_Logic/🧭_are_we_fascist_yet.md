...
```mermaid
flowchart TD
    A["Pluralist democracy"] --> B["Institutional capture or rights erosion"]
    B --> C["Authoritarian function"]
    C --> D["Protofascist mobilisation"]
    D --> E["Fascist consolidation"]
    B --> F["Review, repair and democratic renewal"]
    C --> F
```
