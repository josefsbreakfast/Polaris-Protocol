...
flowchart LR
    %% Left: Extraction
    subgraph EX[Extraction Loop]
        direction TB
        A1[High-ability / creative individual] --> B1[Ideas & insights shared in system]
        B1 --> C1[Institutional interfaces<br/>classes • committees • pilots]
        C1 --> D1[Data economy<br/>formal scores & internal metrics]
        C1 --> E1[Story economy<br/>social reputation & notes]
        D1 --> F1[Knowledge extraction<br/>ideas adopted by system]
        E1 --> G1[Containment narrative<br/>‘low ability’ / ‘unstable’ / ‘poor fit’]
        F1 --> H1[System benefit<br/>innovation without attribution]
        G1 --> H1
        H1 --> I1[Hierarchy preservation]
        I1 --> J1[Feedback: narrative justified, loop restarts]
    end

    %% Right: Reclamation
    subgraph RE[Counter-Extraction / Reclamation Loop]
        direction TB
        A2[Recognition of pattern] --> B2[Archive & provenance]
        B2 --> C2[Document neutrally • keep evidence]
        C2 --> D2[Find allies • external witnesses]
        D2 --> E2[Restate work publicly<br/>timestamp / repository]
        E2 --> F2[New narrative grounded in traceable authorship]
        F2 --> G2[Invite correction • systemic repair]
        G2 --> H2[Resilience & continuation]
        H2 --> I2[Collective learning • templates for others]
    end
