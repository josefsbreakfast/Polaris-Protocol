...
```mermaid
flowchart TD
    A["Law, policy and governance"]
    B["Procurement and professional services"]
    C["Information systems and risk categories"]
    D["Institutional decision-making"]
    E["Restrictions, referrals and responses"]
    F["Effects on the affected person"]
    G["Review, challenge and correction"]
