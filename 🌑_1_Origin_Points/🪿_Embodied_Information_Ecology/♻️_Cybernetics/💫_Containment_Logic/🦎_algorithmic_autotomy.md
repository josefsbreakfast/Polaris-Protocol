...
> - [📚 Memory, Market, and the Machinery of Data Exhaust](./📚_memory_market_machinery_of_data_exhaust.md) — *persistence of behavioural traces and derived data*  
> - [🦠 Systemic Porosity](./🦠_systemic_porosity.md) — *signals crossing nominal boundaries*  
> - [🦠 AI UK Due Diligence & Autoimmunity Map](./🦠_ai_uk_due_diligence_and_autoimmunity_map.md) — *dependency mapping and institutional assurance across AI stacks*  
> - [🧭 Reflexive Risk](./🧭_reflexive_risk.md) — *systems changing what they measure*  
> - [🧨 We Are Already Paying the Cost](./🧨_we_are_already_paying_the_cost.md) — *distributed costs created when unsafe dependencies cannot be released*  
>
> 🏮 Return To:
>
