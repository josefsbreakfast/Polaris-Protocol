...
```mermaid
flowchart TD
  A[⚠️ Threat Perception] --> B[🛡️ Defensive Measures]
  B --> C[🏰 Increased Centralisation]
  C --> D[🔍 Expanded Monitoring]
  D --> E[🚪 Reduced Permeability]
  E --> F[😰 Social Fear & Siege Psychology]

  F --> G[⚔️ Emergency Powers]
  G --> H[🧊 Normalised Exceptionalism]

  H --> B

  I[🌉 Defensive Permeability] -.-> B
  I -.-> E

  J[🫀 Guardianship Ethics] -.-> G
  J -.-> H
```
