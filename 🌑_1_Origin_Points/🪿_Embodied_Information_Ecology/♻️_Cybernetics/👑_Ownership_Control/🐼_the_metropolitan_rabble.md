...
flowchart TD
    A[Senior Leadership]
    B[Command / Directorate]
    C[Local or Specialist Unit]
    D[Supervisor]
    E[Frontline Officer]
    F[Public Encounter]
...
```mermaid
flowchart TD
    A[State Grants Coercive Authority]
    B[Organisation Delegates Discretion]
    C[Officer Encounters Uncertain Situation]
    D[Rapid Decision]
    E[Outcome]
    F[Supervision / Review]
...
flowchart TD
    ...
    D[Finding]
    E[Learning]
    F[Training / Policy / Design Change]
    G[Future Practice]
    H[New Incident Data]
...
```mermaid
flowchart TD
    A[Public Grants Legitimacy]
    B[State Grants Legal Authority]
    C[Leadership Sets Organisation]
    D[Supervisors Translate Standards]
    E[Officers Exercise Discretion]
    F[Public Experiences Outcome]
    G[Oversight Reviews]
    H[Learning Returns]
...
flowchart TD
    ...
    B[Police Observation]
    C[Police Decision]
    D[Police Action]
    E[Public Experience]
    F[Trust / Behaviour Changes]
    G[Information Available to Police]
