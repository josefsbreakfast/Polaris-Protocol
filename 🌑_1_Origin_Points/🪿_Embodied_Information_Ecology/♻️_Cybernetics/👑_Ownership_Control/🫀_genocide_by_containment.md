...
```mermaid
flowchart TD
    A["Population-level harm"] --> B["Separate institutional sensors"]
    B --> C["Local controllers act within remit"]
    C --> D["Cases close; targets report green"]
    D --> E["No owner integrates survival outcomes"]
    E --> F["Architecture remains unchanged"]
    F --> A
```
