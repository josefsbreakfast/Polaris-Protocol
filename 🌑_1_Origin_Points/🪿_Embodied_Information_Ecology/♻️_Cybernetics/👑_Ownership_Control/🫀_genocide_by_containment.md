...
The term **“genocide by containment”** is used here diagnostically and metaphorically, not as a direct legal accusation. It does not describe explicit extermination policy, nor does it claim that contemporary governance systems are inherently genocidal in the legal sense. Rather, it describes a structural condition in which preventable death and life-limiting harm become normalised through procedural indifference, optimisation drift, fragmented accountability, and outcome orphaning.
...
Their core design assumptions emerged within stratified political orders. Their primary functions often included:
...
They were not originally optimised for universal equality.
...
Modern governance increasingly operates through:
...
The safety net is no longer primarily relational.  
It is procedural.
...
They are often less structurally equipped for:

- Cross-silo outcome ownership  
- Holistic survival accountability  
- Adaptive human-centred redesign  

When such governance models scale globally — and are layered with automation — their structural properties scale with them.
...
Speed can increase.  
Responsibility diffusion can increase.
...
1. **Persistent excess mortality associated with policy environments.**  
...
Comparable dynamics have been discussed across research into austerity-linked mortality, detention-related deaths, welfare-sanction harms, and long-term exclusion from essential services.
...
The Holocaust did not begin with extermination camps. It involved earlier stages including classification, exclusion, legal redefinition, bureaucratic compliance, and the incremental normalisation of group-based disposability. Civil registries, transport systems, census data, property law, and administrative procedure became operational components of persecution.
...
The Genocide Convention establishes obligations not only to punish genocide, but also to prevent escalation toward mass atrocity. Prevention scholarship frequently examines indicators such as disproportionate harm, erosion of safeguards, normalisation of discrimination, and weakening accountability structures.
