...
```mermaid
flowchart TD
    A[Initial Allegation or Evidence]
    B[Immediate Actor]
    C[Supervisory Layer]
    D[Institution]
    E[External Partner]
...
flowchart TD
    ...
    C -. unresolved upstream questions .-> F[Residual Accountability Gap]
```
...
```mermaid
flowchart LR
    A[Large Accountability Problem]
    B[Justiciable Portion]
    C[Formal Proceeding]
    D[Decision]
    E[Public Sense of Closure]
    ...
    A -. unresolved remainder .-> F[Residual Questions]
```
