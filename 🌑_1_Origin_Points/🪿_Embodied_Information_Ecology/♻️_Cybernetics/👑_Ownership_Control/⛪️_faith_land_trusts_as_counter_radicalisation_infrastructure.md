...
```mermaid
flowchart TD
    A[Original Institutional Use Declines]
    B[Building Remains]
    C[Legal Ownership]
    D[Custodial Responsibility]
    E[Practical Stewardship]
    F{Viable Transition?}
    ...
    F --> G[Continued Religious Use]
    F --> H[Community / Civic Reuse]
    F --> I[Residential / Commercial Reuse]
    F --> J[Heritage Preservation]
    F --> K[Prolonged Vacancy]
```
...
```mermaid
flowchart LR
    A[Visible Building Condition]
    B[Observation]
    C[Interpretation]
    D[Political / Cultural Narrative]
    E[Community Response]
    F[Changed Building or Social Conditions]
...
```mermaid
flowchart TD
    A[Existing Use Becomes Unsustainable]
    B[Assess Building, Legal Duties and Community Value]
    C[Identify Potential Stewards]
    D{Viable Steward?}

    D -->|Yes| E[Religious / Community / Trust / Mixed-Use Transfer]
    D -->|Not Yet| F[Transitional Custody / Preservation]
    D -->|No| G[Market Disposal or Other Lawful Outcome]

    E --> H[Continued Use and Maintenance]
    F --> C
    G --> I[New Ownership / Use]

    H --> J[Review Social and Physical Sustainability]
    J --> H
```
