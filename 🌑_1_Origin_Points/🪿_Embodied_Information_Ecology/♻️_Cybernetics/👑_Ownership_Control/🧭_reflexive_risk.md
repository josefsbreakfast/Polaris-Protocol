...
```mermaid
flowchart TD
    A["Structural description enters system"] --> B["Institution perceives exposure"]
    B --> C["Review shifts from claim to claimant"]
    C --> D["Access, scope or circulation narrows"]
    D --> E["Less visible challenge"]
    E --> F["Quiet is read as reassurance"]
    F --> A
```
