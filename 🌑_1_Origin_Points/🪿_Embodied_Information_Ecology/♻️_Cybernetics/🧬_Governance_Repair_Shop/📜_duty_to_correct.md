...
```mermaid
flowchart TB
    A["Citizen Identifies Error"] --> B["Public Body Reviews Source"]
    B --> C["Amend / Delete / Contextualise"]
    C --> D["Cross-System Notification"]
    D --> E["Citizen Confirmation<br>(transparent record)"]
    E --> F["Repair of Bureaucratic Memory"]
```
