...
```mermaid
flowchart TD
    A[RIPA 2000<br>Directed surveillance requires a warrant<br>→ applies only to public bodies] -->|Private charity ≠ public authority| D((ACCOUNTABILITY GAP))
    B[UK GDPR / DPA 2018<br>Allows processing in public under<br>'legitimate interests' or 'crime prevention'] -->|Data treated as open-source| D
    C[Charities Act 2011<br>Permits activity that 'protects the community'<br>as charitable purpose] -->|Surveillance framed as community defence| D
    D --> E[Result:<br>Private protest monitoring is lawful<br>but largely unregulated]
```
...
Together these create the **“Civic Surveillance Exemption Zone.”**  
