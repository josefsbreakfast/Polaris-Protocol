...
```mermaid
flowchart TD
  A[📰 Event / Shock / Disclosure] --> B[⏳ Administrative Delay]
  B --> C[📉 Attention Decay]
  C --> D[📋 Procedural Reassurance]
  D --> E[🗓️ Ritual Continuity]
  E --> F[😴 Public Exhaustion]

  F --> G[🌊 Kairotic Rupture]
  G --> H[🚨 Manufactured Urgency]
  H --> I[⚖️ Accelerated Decision Window]

  I --> B

  J[🧭 Long Horizon Stewardship] -.-> B
  J -.-> E
  J -.-> G
```
