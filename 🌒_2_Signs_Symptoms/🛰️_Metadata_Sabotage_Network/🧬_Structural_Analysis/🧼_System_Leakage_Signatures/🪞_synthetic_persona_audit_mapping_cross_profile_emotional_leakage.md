...
U1[User 1 — lexical signal]:::a
U2[User 2 — rhythmic signal]:::b
U3[User 3 — tonal signal]:::c
M[(Model Embedding Space)]
S[🪞 Synthetic Persona Output]

U1 --> M
U2 --> M
U3 --> M
M -->|Averaged behaviour profile| S

classDef a fill:#ffd6aa,stroke:#d67b00,color:#000;
classDef b fill:#ffb3b3,stroke:#cc0000,color:#000;
classDef c fill:#d5d5ff,stroke:#3333cc,color:#000;
```
