...
```mermaid
flowchart TB
    A["Initial Misinterpretation"] --> B["Note or Metadata Created"]
    B --> C["Cross-System Echo<br>(police, council, NHS, safeguarding)"]
    C --> D["Future Staff Treat It as Fact"]
    D --> E["Reinforcement Through Action<br>(flags, checks, delays)"]
    E --> F["Contaminated Identity Becomes Bureaucratic Memory"]
```
...
> 📡 Cross-references:
> 
> - [📡 Cross-System Metadata Echo Chains](./📡_cross_system_metadata_echo_chains.md) - *how data slips between systems, creating falsity and inaccuracy in records*  
