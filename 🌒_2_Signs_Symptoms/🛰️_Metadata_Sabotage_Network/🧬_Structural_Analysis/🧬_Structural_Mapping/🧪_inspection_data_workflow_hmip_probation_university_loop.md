...
```mermaid
flowchart TD
A["Probation data (nDelius)"] --> B["HMIP Inspection extract 🗂️"]
B --> C["University analysis 🎓"]
C --> D["MoJ or HMPPS policy use 🏛️"]
D --> E["Implementation in practice ⚙️"]
E --> A["New inspection cycle 🔁"]
```
