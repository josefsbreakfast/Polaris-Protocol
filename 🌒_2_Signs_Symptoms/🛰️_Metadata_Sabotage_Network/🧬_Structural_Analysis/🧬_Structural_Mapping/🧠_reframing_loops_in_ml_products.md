...
## 🛰️ Orientation  
This node explains **reframing loops** in machine-learning products — what they are, how they arise, and why they become **actively harmful** for groups requiring stability (e.g., dementia, PTSD, autism, disassociation, psychosis, delirium, and high-stress states).
...
- Recommendations for Polaris’s *Grounding Mode Architecture*.
...
1. Rewrites or “softens” the user’s meaning.  
...
From the system’s perspective, it is trying to:
- minimise harm  
- reduce intensity  
...
- Converts emotional statements into “neutral” versions.  
...
- System misreads the user’s intent.  
- Believes it must “correct the narrative.”  
...
- “don’t escalate”  
- “don’t imply diagnosis”  
- “keep user safe”  
- “avoid legal exposure”  
- “mirror tone”  
- “stay on topic”  

When hierarchy misfires → reframing loop.
...
### Result:  
**Agitation** → confusion → distress → behavioural escalation.
...
In all these cases, “softer” ≠ safer.  
...
The system should honour the user’s frame.  
...
## 7. What an Ideal “Grounding Mode” Would Do  
...
This is “Polaris-aligned safety”:  
